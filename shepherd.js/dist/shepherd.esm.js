...
function mergeTooltipConfig(tourOptions, options) {
    return {
        floatingUIOptions: source_default(tourOptions.floatingUIOptions || {}, options.floatingUIOptions || {})
    };
}
/**
...
function getFloatingUIOptions(attachToOptions, step) {
    ...
    return source_default(step.options.floatingUIOptions || {}, options);
}
...
class Step extends Evented {
    ...
    _setOptions(options = {}) {
        ...
        tourOptions = source_default({}, tourOptions || {});
