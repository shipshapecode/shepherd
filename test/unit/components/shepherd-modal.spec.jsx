...
import ShepherdModal, { getModalInstance } from '../../../shepherd.js/src/components/shepherd-modal';
...
describe('components/ShepherdModal', () => {
  describe('closeModalOpening()', function () {
    it('sets values back to 0', async () => {
      ...
      preactRender(h(ShepherdModal, {}), container);
      const modalRef = getModalInstance();
