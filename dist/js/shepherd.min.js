...
!d.includes(a.name));c.modifiers=Array.from(new Set([...b,...a.popperOptions.modifiers]))}return c}return b}function v(){}function Jb(a,b){for(let c in b)a[c]=b[c];return a}function T(a){return a()}function Ya(a){return"function"===typeof a}function H(a,b){return a!=a?b==b:a!==b||a&&"object"===typeof a||"function"===typeof a}function w(a){a.parentNode.removeChild(a)}function Za(a){return document.createElementNS("http://www.w3.org/2000/svg",a)}function la(a,b,c,d){a.addEventListener(b,c,d);return()=>
a.removeEventListener(b,c,d)}function q(a,b,c){null==c?a.removeAttribute(b):a.getAttribute(b)!==c&&a.setAttribute(b,c)}function $a(a,b){let c=Object.getOwnPropertyDescriptors(a.__proto__);for(let d in b)null==b[d]?a.removeAttribute(d):"style"===d?a.style.cssText=b[d]:"__value"===d?a.value=a[d]=b[d]:c[d]&&c[d].set?a[d]=b[d]:q(a,d,b[d])}function U(a,b,c){a.classList[c?"add":"remove"](b)}function ma(){if(!V)throw Error("Function called outside component initialization");return V}function za(a){na.push(a)}
...
null);c(1,h=d.classes);if(d.disabled){var b=d.disabled;b=S(b)?b.call(e):b}else b=!1;c(2,k=b);c(3,m=d.label);c(4,g=d.secondary);c(5,l=d.text)}};return[f,h,k,m,g,l,d,e]}function cb(a,b,c){a=a.slice();a[2]=b[c];return a}function db(a){let b,c,d=a[1],e=[];for(let b=0;b<d.length;b+=1)e[b]=eb(cb(a,d,b));let f=a=>r(e[a],1,1,()=>{e[a]=null});return{c(){for(let a=0;a<e.length;a+=1)e[a].c();b=document.createTextNode("")},m(a,d){for(let b=0;b<e.length;b+=1)e[b].m(a,d);a.insertBefore(b,d||null);c=!0},p(a,c){if(c&
...
2&&(d.config=a[2]);c&1&&(d.step=a[0]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);c=!1},d(a){M(b,a)}}}function Ob(a){let b,c,d=a[1]&&db(a);return{c(){b=document.createElement("footer");d&&d.c();q(b,"class","shepherd-footer")},m(a,f){a.insertBefore(b,f||null);d&&d.m(b,null);c=!0},p(a,[c]){a[1]?d?(d.p(a,c),c&2&&n(d,1)):(d=db(a),d.c(),n(d,1),d.m(b,null)):d&&(N(),r(d,1,1,()=>{d=null}),P())},i(a){c||(n(d),c=!0)},o(a){r(d);c=!1},d(a){a&&w(b);d&&d.d()}}}function Pb(a,b,c){let {step:d}=
...
"Close Tour")&&q(b,"aria-label",d)},i:v,o:v,d(a){a&&w(b);e=!1;f()}}}function Rb(a,b,c){let {cancelIcon:d}=b,{step:e}=b;a.$set=a=>{"cancelIcon"in a&&c(0,d=a.cancelIcon);"step"in a&&c(2,e=a.step)};return[d,a=>{a.preventDefault();e.cancel()},e]}function Sb(a){let b;return{c(){b=document.createElement("h3");q(b,"id",a[1]);q(b,"class","shepherd-title")},m(c,d){c.insertBefore(b,d||null);a[3](b)},p(a,[d]){d&2&&q(b,"id",a[1])},i:v,o:v,d(c){c&&w(b);a[3](null)}}}function Tb(a,b,c){let {labelId:d}=b,{element:e}=
b,{title:f}=b;ma().$$.after_update.push(()=>{S(f)&&c(2,f=f());c(0,e.innerHTML=f,e)});a.$set=a=>{"labelId"in a&&c(1,d=a.labelId);"element"in a&&c(0,e=a.element);"title"in a&&c(2,f=a.title)};return[e,d,f,function(a){W[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}function fb(a){let b,c;b=new Ub({props:{labelId:a[0],title:a[2]}});return{c(){Q(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&1&&(d.labelId=a[0]);c&4&&(d.title=a[2]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);
c=!1},d(a){M(b,a)}}}function gb(a){let b,c;b=new Vb({props:{cancelIcon:a[3],step:a[1]}});return{c(){Q(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&8&&(d.cancelIcon=a[3]);c&2&&(d.step=a[1]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);c=!1},d(a){M(b,a)}}}function Wb(a){let b,c,d,e=a[2]&&fb(a),f=a[3]&&a[3].enabled&&gb(a);return{c(){b=document.createElement("header");e&&e.c();c=document.createTextNode(" ");f&&f.c();q(b,"class","shepherd-header")},m(a,k){a.insertBefore(b,
k||null);e&&e.m(b,null);b.appendChild(c);f&&f.m(b,null);d=!0},p(a,[d]){a[2]?e?(e.p(a,d),d&4&&n(e,1)):(e=fb(a),e.c(),n(e,1),e.m(b,c)):e&&(N(),r(e,1,1,()=>{e=null}),P());a[3]&&a[3].enabled?f?(f.p(a,d),d&8&&n(f,1)):(f=gb(a),f.c(),n(f,1),f.m(b,null)):f&&(N(),r(f,1,1,()=>{f=null}),P())},i(a){d||(n(e),n(f),d=!0)},o(a){r(e);r(f);d=!1},d(a){a&&w(b);e&&e.d();f&&f.d()}}}function Xb(a,b,c){let {labelId:d}=b,{step:e}=b,f,h;a.$set=a=>{"labelId"in a&&c(0,d=a.labelId);"step"in a&&c(1,e=a.step)};a.$$.update=()=>
{a.$$.dirty&2&&(c(2,f=e.options.title),c(3,h=e.options.cancelIcon))};return[d,e,f,h]}function Yb(a){let b;return{c(){b=document.createElement("div");q(b,"class","shepherd-text");q(b,"id",a[1])},m(c,d){c.insertBefore(b,d||null);a[3](b)},p(a,[d]){d&2&&q(b,"id",a[1])},i:v,o:v,d(c){c&&w(b);a[3](null)}}}function Zb(a,b,c){let {descriptionId:d}=b,{element:e}=b,{step:f}=b;ma().$$.after_update.push(()=>{let {text:a}=f.options;S(a)&&(a=a.call(f));a instanceof HTMLElement?e.appendChild(a):c(0,e.innerHTML=a,
e)});a.$set=a=>{"descriptionId"in a&&c(1,d=a.descriptionId);"element"in a&&c(0,e=a.element);"step"in a&&c(2,f=a.step)};return[e,d,f,function(a){W[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}function hb(a){let b,c;b=new $b({props:{labelId:a[1],step:a[2]}});return{c(){Q(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&2&&(d.labelId=a[1]);c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);c=!1},d(a){M(b,a)}}}function ib(a){let b,c;b=new ac({props:{descriptionId:a[0],
step:a[2]}});return{c(){Q(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&1&&(d.descriptionId=a[0]);c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);c=!1},d(a){M(b,a)}}}function jb(a){let b,c;b=new bc({props:{step:a[2]}});return{c(){Q(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);c=!1},d(a){M(b,a)}}}function cc(a){let b,c=void 0!==a[2].options.title||a[2].options.cancelIcon&&
...
a[2].options.cancelIcon.enabled);c?m?(m.p(a,k),k&4&&n(m,1)):(m=hb(a),m.c(),n(m,1),m.m(b,d)):m&&(N(),r(m,1,1,()=>{m=null}),P());k&4&&(e=void 0!==a[2].options.text);e?g?(g.p(a,k),k&4&&n(g,1)):(g=ib(a),g.c(),n(g,1),g.m(b,f)):g&&(N(),r(g,1,1,()=>{g=null}),P());k&4&&(h=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length);h?l?(l.p(a,k),k&4&&n(l,1)):(l=jb(a),l.c(),n(l,1),l.m(b,null)):l&&(N(),r(l,1,1,()=>{l=null}),P())},i(a){k||(n(m),n(g),n(l),k=!0)},o(a){r(m);r(g);r(l);k=!1},d(a){a&&w(b);m&&
m.d();g&&g.d();l&&l.d()}}}function dc(a,b,c){let {descriptionId:d}=b,{labelId:e}=b,{step:f}=b;a.$set=a=>{"descriptionId"in a&&c(0,d=a.descriptionId);"labelId"in a&&c(1,e=a.labelId);"step"in a&&c(2,f=a.step)};return[d,e,f]}function kb(a){let b;return{c(){b=document.createElement("div");q(b,"class","shepherd-arrow");q(b,"data-popper-arrow","")},m(a,d){a.insertBefore(b,d||null)},d(a){a&&w(b)}}}function ec(a){let b,c,d,e,f,h,k,m,g=a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element&&
a[4].options.attachTo.on&&kb();d=new fc({props:{descriptionId:a[2],labelId:a[3],step:a[4]}});let l=[{"aria-describedby":e=void 0!==a[4].options.text?a[2]:null},{"aria-labelledby":f=a[4].options.title?a[3]:null},a[1],{role:"dialog"},{tabindex:"0"}],p={};for(let a=0;a<l.length;a+=1)p=Jb(p,l[a]);return{c(){b=document.createElement("div");g&&g.c();c=document.createTextNode(" ");Q(d.$$.fragment);$a(b,p);U(b,"shepherd-has-cancel-icon",a[5]);U(b,"shepherd-has-title",a[6]);U(b,"shepherd-element",!0)},m(e,
...
{"aria-labelledby":f},k&2&&a[1],{role:"dialog"},{tabindex:"0"}];let b={},c={},d={$$scope:1},g=l.length;for(;g--;){let a=l[g],e=k[g];if(e){for(u in a)u in e||(c[u]=1);for(let a in e)d[a]||(b[a]=e[a],d[a]=1);l[g]=e}else for(let b in a)d[b]=1}for(let a in c)a in b||(b[a]=void 0);var u=b}$a(m,p=u);U(b,"shepherd-has-cancel-icon",a[5]);U(b,"shepherd-has-title",a[6]);U(b,"shepherd-element",!0)},i(a){h||(n(d.$$.fragment,a),h=!0)},o(a){r(d.$$.fragment,a);h=!1},d(c){c&&w(b);g&&g.d();M(d);a[13](null);k=!1;m()}}}
function lb(a){return a.split(" ").filter(a=>!!a.length)}function gc(a,b,c){let {classPrefix:d}=b,{element:e}=b,{descriptionId:f}=b,{firstFocusableElement:h}=b,{focusableElements:k}=b,{labelId:m}=b,{lastFocusableElement:g}=b,{step:l}=b,{dataStepId:p}=b,t,y,A;ma().$$.on_mount.push(()=>{c(1,p={[`data-${d}shepherd-step-id`]:l.id});c(9,k=e.querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex="0"]'));c(8,h=k[0]);
c(10,g=k[k.length-1])});ma().$$.after_update.push(()=>{if(A!==l.options.classes){var a=A;Z(a)&&(a=lb(a),a.length&&e.classList.remove(...a));a=A=l.options.classes;Z(a)&&(a=lb(a),a.length&&e.classList.add(...a))}});a.$set=a=>{"classPrefix"in a&&c(11,d=a.classPrefix);"element"in a&&c(0,e=a.element);"descriptionId"in a&&c(2,f=a.descriptionId);"firstFocusableElement"in a&&c(8,h=a.firstFocusableElement);"focusableElements"in a&&c(9,k=a.focusableElements);"labelId"in a&&c(3,m=a.labelId);"lastFocusableElement"in
a&&c(10,g=a.lastFocusableElement);"step"in a&&c(4,l=a.step);"dataStepId"in a&&c(1,p=a.dataStepId)};a.$$.update=()=>{a.$$.dirty&16&&(c(5,t=l.options&&l.options.cancelIcon&&l.options.cancelIcon.enabled),c(6,y=l.options&&l.options.title))};return[e,p,f,m,l,t,y,a=>{const {tour:b}=l;switch(a.keyCode){case 9:if(0===k.length){a.preventDefault();break}a.shiftKey?document.activeElement===h&&(a.preventDefault(),g.focus()):document.activeElement===g&&(a.preventDefault(),h.focus());break;case 27:b.options.exitOnEsc&&
...
isReferenceHidden:e,hasPopperEscaped:h};b.attributes.popper=Object.assign(Object.assign({},b.attributes.popper),{},{"data-popper-reference-hidden":e,"data-popper-escaped":h})}}]});let V,ha=[],W=[],na=[],bb=[],Kb=Promise.resolve(),Ca=!1,Aa=!1,Ba=new Set,oa=new Set,O;class K{$destroy(){M(this,1);this.$destroy=v}$on(a,b){let c=this.$$.callbacks[a]||(this.$$.callbacks[a]=[]);c.push(b);return()=>{let a=c.indexOf(b);-1!==a&&c.splice(a,1)}}$set(){}}class Nb extends K{constructor(a){super();I(this,a,Mb,Lb,
H,{config:6,step:7})}}class bc extends K{constructor(a){super();I(this,a,Pb,Ob,H,{step:0})}}class Vb extends K{constructor(a){super();I(this,a,Rb,Qb,H,{cancelIcon:0,step:2})}}class Ub extends K{constructor(a){super();I(this,a,Tb,Sb,H,{labelId:1,element:0,title:2})}}class $b extends K{constructor(a){super();I(this,a,Xb,Wb,H,{labelId:0,step:1})}}class ac extends K{constructor(a){super();I(this,a,Zb,Yb,H,{descriptionId:1,element:0,step:2})}}class fc extends K{constructor(a){super();I(this,a,dc,cc,H,
...
I(this,a,kc,jc,H,{element:0,openingProperties:4,getElement:5,closeModalOpening:6,hide:7,positionModalOpening:8,setupForStep:9,show:10})}get getElement(){return this.$$.ctx[5]}get closeModalOpening(){return this.$$.ctx[6]}get hide(){return this.$$.ctx[7]}get positionModalOpening(){return this.$$.ctx[8]}get setupForStep(){return this.$$.ctx[9]}get show(){return this.$$.ctx[10]}}let X=new Da;class qc extends Da{constructor(a={}){super(a);Ha(this);this.options=Object.assign({},{exitOnEsc:!0,keyboardNavigation:!0},
