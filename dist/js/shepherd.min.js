...
return{c:function(){b=document.createElement("footer");d&&d.c();t(b,"class","shepherd-footer")},m:function(a,f){a.insertBefore(b,f||null);d&&d.m(b,null);c=!0},p:function(a,c){c=c[0];a[1]?d?(d.p(a,c),p(d,1)):(d=db(a),d.c(),p(d,1),d.m(b,null)):d&&(N(),v(d,1,1,function(){d=null}),P())},i:function(a){c||(p(d),c=!0)},o:function(a){v(d);c=!1},d:function(a){a&&B(b);d&&d.d()}}}function Mb(a,b,c){var d=b.step;a.$set=function(a){"step"in a&&c(0,d=a.step)};var e;a.$$.update=function(){a.$$.dirty&1&&c(1,e=d.options.buttons)};
return[d,e]}function Nb(a){var b,c,d,e;return{c:function(){b=document.createElement("button");c=document.createElement("span");c.textContent="\u00d7";t(c,"aria-hidden","true");t(b,"aria-label",d=a[0].label?a[0].label:"Close Tour");t(b,"class","shepherd-cancel-icon");t(b,"type","button")},m:function(d,h,k){d.insertBefore(b,h||null);b.appendChild(c);k&&e();e=la(b,"click",a[1])},p:function(a,c){c[0]&1&&d!==(d=a[0].label?a[0].label:"Close Tour")&&t(b,"aria-label",d)},i:A,o:A,d:function(a){a&&B(b);e()}}}
function Ob(a,b,c){var d=b.cancelIcon,e=b.step;a.$set=function(a){"cancelIcon"in a&&c(0,d=a.cancelIcon);"step"in a&&c(2,e=a.step)};return[d,function(a){a.preventDefault();e.cancel()},e]}function Pb(a){var b;return{c:function(){b=document.createElement("h3");t(b,"id",a[1]);t(b,"class","shepherd-title")},m:function(c,d){c.insertBefore(b,d||null);a[3](b)},p:function(a,d){d[0]&2&&t(b,"id",a[1])},i:A,o:A,d:function(c){c&&B(b);a[3](null)}}}function Qb(a,b,c){var d=b.labelId,e=b.element,f=b.title;ma().$$.after_update.push(function(){T(f)&&
c(2,f=f());c(0,e.innerHTML=f,e)});a.$set=function(a){"labelId"in a&&c(1,d=a.labelId);"element"in a&&c(0,e=a.element);"title"in a&&c(2,f=a.title)};return[e,d,f,function(a){X[a?"unshift":"push"](function(){c(0,e=a)})}]}function fb(a){var b,c=new Rb({props:{labelId:a[0],title:a[2]}});return{c:function(){Q(c.$$.fragment)},m:function(a,e){L(c,a,e);b=!0},p:function(a,b){var d={};b&1&&(d.labelId=a[0]);b&4&&(d.title=a[2]);c.$set(d)},i:function(a){b||(p(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,
a);b=!1},d:function(a){M(c,a)}}}function gb(a){var b,c=new Sb({props:{cancelIcon:a[3],step:a[1]}});return{c:function(){Q(c.$$.fragment)},m:function(a,e){L(c,a,e);b=!0},p:function(a,b){var d={};b&8&&(d.cancelIcon=a[3]);b&2&&(d.step=a[1]);c.$set(d)},i:function(a){b||(p(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){M(c,a)}}}function Tb(a){var b,c,d,e=a[2]&&fb(a),f=a[3]&&a[3].enabled&&gb(a);return{c:function(){b=document.createElement("header");e&&e.c();c=document.createTextNode(" ");
f&&f.c();t(b,"class","shepherd-header")},m:function(a,k){a.insertBefore(b,k||null);e&&e.m(b,null);b.appendChild(c);f&&f.m(b,null);d=!0},p:function(a,d){d=d[0];a[2]?e?(e.p(a,d),p(e,1)):(e=fb(a),e.c(),p(e,1),e.m(b,c)):e&&(N(),v(e,1,1,function(){e=null}),P());a[3]&&a[3].enabled?f?(f.p(a,d),p(f,1)):(f=gb(a),f.c(),p(f,1),f.m(b,null)):f&&(N(),v(f,1,1,function(){f=null}),P())},i:function(a){d||(p(e),p(f),d=!0)},o:function(a){v(e);v(f);d=!1},d:function(a){a&&B(b);e&&e.d();f&&f.d()}}}function Ub(a,b,c){var d=
b.labelId,e=b.step,f,h;a.$set=function(a){"labelId"in a&&c(0,d=a.labelId);"step"in a&&c(1,e=a.step)};a.$$.update=function(){a.$$.dirty&2&&(c(2,f=e.options.title),c(3,h=e.options.cancelIcon))};return[d,e,f,h]}function Vb(a){var b;return{c:function(){b=document.createElement("div");t(b,"class","shepherd-text");t(b,"id",a[1])},m:function(c,d){c.insertBefore(b,d||null);a[3](b)},p:function(a,d){d[0]&2&&t(b,"id",a[1])},i:A,o:A,d:function(c){c&&B(b);a[3](null)}}}function Wb(a,b,c){var d=b.descriptionId,
e=b.element,f=b.step;ma().$$.after_update.push(function(){var a=f.options.text;T(a)&&(a=a.call(f));a instanceof HTMLElement?e.appendChild(a):c(0,e.innerHTML=a,e)});a.$set=function(a){"descriptionId"in a&&c(1,d=a.descriptionId);"element"in a&&c(0,e=a.element);"step"in a&&c(2,f=a.step)};return[e,d,f,function(a){X[a?"unshift":"push"](function(){c(0,e=a)})}]}function hb(a){var b,c=new Xb({props:{labelId:a[1],step:a[2]}});return{c:function(){Q(c.$$.fragment)},m:function(a,e){L(c,a,e);b=!0},p:function(a,
b){var d={};b&2&&(d.labelId=a[1]);b&4&&(d.step=a[2]);c.$set(d)},i:function(a){b||(p(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){M(c,a)}}}function ib(a){var b,c=new Yb({props:{descriptionId:a[0],step:a[2]}});return{c:function(){Q(c.$$.fragment)},m:function(a,e){L(c,a,e);b=!0},p:function(a,b){var d={};b&1&&(d.descriptionId=a[0]);b&4&&(d.step=a[2]);c.$set(d)},i:function(a){b||(p(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){M(c,a)}}}function jb(a){var b,
c=new Zb({props:{step:a[2]}});return{c:function(){Q(c.$$.fragment)},m:function(a,e){L(c,a,e);b=!0},p:function(a,b){var d={};b&4&&(d.step=a[2]);c.$set(d)},i:function(a){b||(p(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){M(c,a)}}}function $b(a){var b,c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled,d,e=void 0!==a[2].options.text,f,h=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length,k,m=c&&hb(a),g=e&&ib(a),l=h&&jb(a);
return{c:function(){b=document.createElement("div");m&&m.c();d=document.createTextNode(" ");g&&g.c();f=document.createTextNode(" ");l&&l.c();t(b,"class","shepherd-content")},m:function(a,c){a.insertBefore(b,c||null);m&&m.m(b,null);b.appendChild(d);g&&g.m(b,null);b.appendChild(f);l&&l.m(b,null);k=!0},p:function(a,k){k=k[0];k&4&&(c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled);c?m?(m.p(a,k),p(m,1)):(m=hb(a),m.c(),p(m,1),m.m(b,d)):m&&(N(),v(m,1,1,function(){m=
null}),P());k&4&&(e=void 0!==a[2].options.text);e?g?(g.p(a,k),p(g,1)):(g=ib(a),g.c(),p(g,1),g.m(b,f)):g&&(N(),v(g,1,1,function(){g=null}),P());k&4&&(h=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length);h?l?(l.p(a,k),p(l,1)):(l=jb(a),l.c(),p(l,1),l.m(b,null)):l&&(N(),v(l,1,1,function(){l=null}),P())},i:function(a){k||(p(m),p(g),p(l),k=!0)},o:function(a){v(m);v(g);v(l);k=!1},d:function(a){a&&B(b);m&&m.d();g&&g.d();l&&l.d()}}}function ac(a,b,c){var d=b.descriptionId,e=b.labelId,f=b.step;
a.$set=function(a){"descriptionId"in a&&c(0,d=a.descriptionId);"labelId"in a&&c(1,e=a.labelId);"step"in a&&c(2,f=a.step)};return[d,e,f]}function kb(a){var b;return{c:function(){b=document.createElement("div");t(b,"class","shepherd-arrow");t(b,"data-popper-arrow","")},m:function(a,d){a.insertBefore(b,d||null)},d:function(a){a&&B(b)}}}function bc(a){for(var b,c,d,e,f=a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element&&kb(),h=new cc({props:{descriptionId:a[2],labelId:a[3],step:a[4]}}),
