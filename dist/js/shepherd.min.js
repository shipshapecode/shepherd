...
c._updateStepTargetOnHide=function(){this.options.highlightClass&&this.target.classList.remove(this.options.highlightClass);this.target.classList.remove(this.classPrefix+"shepherd-enabled",this.classPrefix+"shepherd-target")};return b}(Ba),kc=function(a){function b(b){var c=a.call(this)||this;I(w(c),b,hc,gc,H,{element:0,openingProperties:4,getElement:5,closeModalOpening:6,hide:7,positionModalOpening:8,setupForStep:9,show:10});return c}C(b,a);S(b,[{key:"getElement",get:function(){return this.$$.ctx[5]}},
