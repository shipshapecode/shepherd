...
function x(a){return a?(a.nodeName||"").toLowerCase():null}function y(a){return"[object Window]"!==a.toString()?(a=a.ownerDocument)?a.defaultView||window:window:a}function aa(a){var b=y(a).Element;return a instanceof b||a instanceof Element}function B(a){var b=y(a).HTMLElement;return a instanceof b||a instanceof HTMLElement}function C(a){return a.split("-")[0]}function qa(a){return{x:a.offsetLeft,y:a.offsetTop,width:a.offsetWidth,height:a.offsetHeight}}function Ia(a,b){var c=b.getRootNode&&b.getRootNode();
if(a.contains(b))return!0;var d;if(d=c)d=y(c).ShadowRoot,d=c instanceof d||c instanceof ShadowRoot;if(d){do{if(b&&a.isSameNode(b))return!0;b=b.parentNode||b.host}while(b)}return!1}function F(a){return y(a).getComputedStyle(a)}function G(a){return((aa(a)?a.ownerDocument:a.document)||window.document).documentElement}function ja(a){return"html"===x(a)?a:a.assignedSlot||a.parentNode||a.host||G(a)}function Ja(a){if(!B(a)||"fixed"===F(a).position)return null;if(a=a.offsetParent){var b=G(a);if("body"===
x(a)&&"static"===F(a).position&&"static"!==F(b).position)return b}return a}function ba(a){for(var b=y(a),c=Ja(a);c&&0<=["table","td","th"].indexOf(x(c))&&"static"===F(c).position;)c=Ja(c);if(c&&"body"===x(c)&&"static"===F(c).position)return b;if(!c)a:{for(a=ja(a);B(a)&&0>["html","body"].indexOf(x(a));)if(c=F(a),"none"!==c.transform||"none"!==c.perspective||c.willChange&&"auto"!==c.willChange){c=a;break a}else a=a.parentNode;c=null}return c||b}function ra(a){return 0<=["top","bottom"].indexOf(a)?"x":
"y"}function Ka(a){return Object.assign(Object.assign({},{top:0,right:0,bottom:0,left:0}),a)}function La(a,b){return b.reduce(function(b,d){b[d]=a;return b},{})}function Ma(a){var b,c=a.popper,d=a.popperRect,e=a.placement,f=a.offsets,h=a.position,k=a.gpuAcceleration,m=a.adaptive,g=window.devicePixelRatio||1;a=Math.round(f.x*g)/g||0;g=Math.round(f.y*g)/g||0;var l=f.hasOwnProperty("x");f=f.hasOwnProperty("y");var p="left",t="top",z=window;if(m){var A=ba(c);A===y(c)&&(A=G(c));"top"===e&&(t="bottom",
g-=A.clientHeight-d.height,g*=k?1:-1);"left"===e&&(p="right",a-=A.clientWidth-d.width,a*=k?1:-1)}c=Object.assign({position:h},m&&tb);if(k){var u;return Object.assign(Object.assign({},c),{},(u={},u[t]=f?"0":"",u[p]=l?"0":"",u.transform=2>(z.devicePixelRatio||1)?"translate("+a+"px, "+g+"px)":"translate3d("+a+"px, "+g+"px, 0)",u))}return Object.assign(Object.assign({},c),{},(b={},b[t]=f?g+"px":"",b[p]=l?a+"px":"",b.transform="",b))}function ka(a){return a.replace(/left|right|bottom|top/g,function(a){return ub[a]})}
function Na(a){return a.replace(/start|end/g,function(a){return vb[a]})}function ca(a){a=a.getBoundingClientRect();return{width:a.width,height:a.height,top:a.top,right:a.right,bottom:a.bottom,left:a.left,x:a.left,y:a.top}}function sa(a){a=y(a);return{scrollLeft:a.pageXOffset,scrollTop:a.pageYOffset}}function ta(a){return ca(G(a)).left+sa(a).scrollLeft}function ua(a){a=F(a);return/auto|scroll|overlay|hidden/.test(a.overflow+a.overflowY+a.overflowX)}function Oa(a){return 0<=["html","body","#document"].indexOf(x(a))?
a.ownerDocument.body:B(a)&&ua(a)?a:Oa(ja(a))}function da(a,b){void 0===b&&(b=[]);var c=Oa(a);a="body"===x(c);var d=y(c);c=a?[d].concat(d.visualViewport||[],ua(c)?c:[]):c;b=b.concat(c);return a?b:b.concat(da(ja(c)))}function va(a){return Object.assign(Object.assign({},a),{},{left:a.x,top:a.y,right:a.x+a.width,bottom:a.y+a.height})}function Pa(a,b){if("viewport"===b){b=y(a);var c=G(a);b=b.visualViewport;var d=c.clientWidth;c=c.clientHeight;var e=0,f=0;b&&(d=b.width,c=b.height,/^((?!chrome|android).)*safari/i.test(navigator.userAgent)||
(e=b.offsetLeft,f=b.offsetTop));a={width:d,height:c,x:e+ta(a),y:f};a=va(a)}else B(b)?(a=ca(b),a.top+=b.clientTop,a.left+=b.clientLeft,a.bottom=a.top+b.clientHeight,a.right=a.left+b.clientWidth,a.width=b.clientWidth,a.height=b.clientHeight,a.x=a.left,a.y=a.top):(f=G(a),a=G(f),e=sa(f),b=f.ownerDocument.body,d=Math.max(a.scrollWidth,a.clientWidth,b?b.scrollWidth:0,b?b.clientWidth:0),c=Math.max(a.scrollHeight,a.clientHeight,b?b.scrollHeight:0,b?b.clientHeight:0),f=-e.scrollLeft+ta(f),e=-e.scrollTop,"rtl"===
F(b||a).direction&&(f+=Math.max(a.clientWidth,b?b.clientWidth:0)-d),a=va({width:d,height:c,x:f,y:e}));return a}function wb(a){var b=da(ja(a)),c=0<=["absolute","fixed"].indexOf(F(a).position)&&B(a)?ba(a):a;return aa(c)?b.filter(function(a){return aa(a)&&Ia(a,c)&&"body"!==x(a)}):[]}function xb(a,b,c){b="clippingParents"===b?wb(a):[].concat(b);c=[].concat(b,[c]);c=c.reduce(function(b,c){c=Pa(a,c);b.top=Math.max(c.top,b.top);b.right=Math.min(c.right,b.right);b.bottom=Math.min(c.bottom,b.bottom);b.left=
Math.max(c.left,b.left);return b},Pa(a,c[0]));c.width=c.right-c.left;c.height=c.bottom-c.top;c.x=c.left;c.y=c.top;return c}function Qa(a){var b=a.reference,c=a.element,d=(a=a.placement)?C(a):null;a=a?a.split("-")[1]:null;var e=b.x+b.width/2-c.width/2,f=b.y+b.height/2-c.height/2;switch(d){case "top":e={x:e,y:b.y-c.height};break;case "bottom":e={x:e,y:b.y+b.height};break;case "right":e={x:b.x+b.width,y:f};break;case "left":e={x:b.x-c.width,y:f};break;default:e={x:b.x,y:b.y}}d=d?ra(d):null;if(null!=
d)switch(f="y"===d?"height":"width",a){case "start":e[d]=Math.floor(e[d])-Math.floor(b[f]/2-c[f]/2);break;case "end":e[d]=Math.floor(e[d])+Math.ceil(b[f]/2-c[f]/2)}return e}function ea(a,b){void 0===b&&(b={});var c=b;b=c.placement;b=void 0===b?a.placement:b;var d=c.boundary,e=void 0===d?"clippingParents":d;d=c.rootBoundary;var f=void 0===d?"viewport":d;d=c.elementContext;d=void 0===d?"popper":d;var h=c.altBoundary,k=void 0===h?!1:h;c=c.padding;c=void 0===c?0:c;c=Ka("number"!==typeof c?c:La(c,fa));
...
0<=["right","bottom"].indexOf(a)?1:-1,c=0<=["top","bottom"].indexOf(a)?"y":"x";g[a]+=l[c]*b})}return g}function yb(a,b){void 0===b&&(b={});var c=b.boundary,d=b.rootBoundary,e=b.padding,f=b.flipVariations,h=b.allowedAutoPlacements,k=void 0===h?Ra:h,m=b.placement.split("-")[1];b=m?f?Sa:Sa.filter(function(a){return a.split("-")[1]===m}):fa;f=b.filter(function(a){return 0<=k.indexOf(a)});0===f.length&&(f=b);var g=f.reduce(function(b,f){b[f]=ea(a,{placement:f,boundary:c,rootBoundary:d,padding:e})[C(f)];
return b},{});return Object.keys(g).sort(function(a,b){return g[a]-g[b]})}function zb(a){if("auto"===C(a))return[];var b=ka(a);return[Na(a),b,Na(b)]}function Ta(a,b,c){void 0===c&&(c={x:0,y:0});return{top:a.top-b.height-c.y,right:a.right-b.width+c.x,bottom:a.bottom-b.height+c.y,left:a.left-b.width-c.x}}function Ua(a){return["top","right","bottom","left"].some(function(b){return 0<=a[b]})}function Ab(a,b,c){void 0===c&&(c=!1);var d=G(b);a=ca(a);var e=B(b),f={scrollLeft:0,scrollTop:0},h={x:0,y:0};if(e||
!e&&!c){if("body"!==x(b)||ua(d))f=b!==y(b)&&B(b)?{scrollLeft:b.scrollLeft,scrollTop:b.scrollTop}:sa(b);B(b)?(h=ca(b),h.x+=b.clientLeft,h.y+=b.clientTop):d&&(h.x=ta(d))}return{x:a.left+f.scrollLeft-h.x,y:a.top+f.scrollTop-h.y,width:a.width,height:a.height}}function Bb(a){function b(a){d.add(a.name);[].concat(a.requires||[],a.requiresIfExists||[]).forEach(function(a){d.has(a)||(a=c.get(a))&&b(a)});e.push(a)}var c=new Map,d=new Set,e=[];a.forEach(function(a){c.set(a.name,a)});a.forEach(function(a){d.has(a.name)||
b(a)});return e}function Cb(a){var b=Bb(a);return Db.reduce(function(a,d){return a.concat(b.filter(function(a){return a.phase===d}))},[])}function Eb(a){var b;return function(){b||(b=new Promise(function(c){Promise.resolve().then(function(){b=void 0;c(a())})}));return b}}function Fb(a){var b=a.reduce(function(a,b){var c=a[b.name];a[b.name]=c?Object.assign(Object.assign(Object.assign({},c),b),{},{options:Object.assign(Object.assign({},c.options),b.options),data:Object.assign(Object.assign({},c.data),
b.data)}):b;return a},{});return Object.keys(b).map(function(a){return b[a]})}function Va(){for(var a=arguments.length,b=Array(a),c=0;c<a;c++)b[c]=arguments[c];return!b.some(function(a){return!(a&&"function"===typeof a.getBoundingClientRect)})}function wa(){wa=Object.assign||function(a){for(var b=1;b<arguments.length;b++){var c=arguments[b],d;for(d in c)Object.prototype.hasOwnProperty.call(c,d)&&(a[d]=c[d])}return a};return wa.apply(this,arguments)}function Gb(){return[{name:"applyStyles",fn({state:a}){Object.keys(a.elements).forEach(b=>
{if("popper"===b){var c=a.attributes[b]||{},d=a.elements[b];Object.assign(d.style,{position:"fixed",left:"50%",top:"50%",transform:"translate(-50%, -50%)"});Object.keys(c).forEach(a=>{let b=c[a];!1===b?d.removeAttribute(a):d.setAttribute(a,!0===b?"":b)})}})}},{name:"computeStyles",options:{adaptive:!1}}]}function Hb(a){let b=Gb(),c={placement:"top",strategy:"fixed",modifiers:[{name:"focusAfterRender",enabled:!0,phase:"afterWrite",fn(){setTimeout(()=>{a.el&&a.el.focus()},300)}}]};return c=wa({},c,
{modifiers:Array.from(new Set([...c.modifiers,...b]))})}function Wa(a){return Z(a)&&""!==a?"-"!==a.charAt(a.length-1)?`${a}-`:a:""}function xa(a){a=a.options.attachTo||{};let b=Object.assign({},a);if(Z(a.element)){try{b.element=document.querySelector(a.element)}catch(c){}b.element||console.error(`The element for this Shepherd step was not found ${a.element}`)}return b}function ya(){let a=Date.now();return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,b=>{let c=(a+16*Math.random())%16|0;a=
Math.floor(a/16);return("x"==b?c:c&3|8).toString(16)})}function Ib(a,b){let c={modifiers:[{name:"preventOverflow",options:{altAxis:!0}},{name:"focusAfterRender",enabled:!0,phase:"afterWrite",fn(){setTimeout(()=>{b.el&&b.el.focus()},300)}}],strategy:"absolute"};b.isCentered()?c=Hb(b):c.placement=a.on;(a=b.tour&&b.tour.options&&b.tour.options.defaultStepOptions)&&(c=Xa(a,c));return c=Xa(b.options,c)}function Xa(a,b){if(a.popperOptions){let c=Object.assign({},b,a.popperOptions);if(a.popperOptions.modifiers&&
0<a.popperOptions.modifiers.length){let d=a.popperOptions.modifiers.map(a=>a.name);b=b.modifiers.filter(a=>!d.includes(a.name));c.modifiers=Array.from(new Set([...b,...a.popperOptions.modifiers]))}return c}return b}function v(){}function Jb(a,b){for(let c in b)a[c]=b[c];return a}function U(a){return a()}function Ya(a){return"function"===typeof a}function H(a,b){return a!=a?b==b:a!==b||a&&"object"===typeof a||"function"===typeof a}function w(a){a.parentNode.removeChild(a)}function Za(a){return document.createElementNS("http://www.w3.org/2000/svg",
a)}function la(a,b,c,d){a.addEventListener(b,c,d);return()=>a.removeEventListener(b,c,d)}function q(a,b,c){null==c?a.removeAttribute(b):a.getAttribute(b)!==c&&a.setAttribute(b,c)}function $a(a,b){let c=Object.getOwnPropertyDescriptors(a.__proto__);for(let d in b)null==b[d]?a.removeAttribute(d):"style"===d?a.style.cssText=b[d]:"__value"===d?a.value=a[d]=b[d]:c[d]&&c[d].set?a[d]=b[d]:q(a,d,b[d])}function V(a,b,c){a.classList[c?"add":"remove"](b)}function ma(){if(!N)throw Error("Function called outside component initialization");
return N}function za(a){na.push(a)}function ab(){if(!Aa){Aa=!0;do{for(var a=0;a<ha.length;a+=1){var b=ha[a];N=b;b=b.$$;if(null!==b.fragment){b.update();b.before_update.forEach(U);let a=b.dirty;b.dirty=[-1];b.fragment&&b.fragment.p(b.ctx,a);b.after_update.forEach(za)}}N=null;for(ha.length=0;W.length;)W.pop()();for(a=0;a<na.length;a+=1)b=na[a],Ba.has(b)||(Ba.add(b),b());na.length=0}while(ha.length);for(;bb.length;)bb.pop()();Aa=Ca=!1;Ba.clear()}}function O(){P={r:0,c:[],p:P}}function Q(){P.r||P.c.forEach(U);
P=P.p}function n(a,b){a&&a.i&&(oa.delete(a),a.i(b))}function r(a,b,c,d){a&&a.o&&!oa.has(a)&&(oa.add(a),P.c.push(()=>{oa.delete(a);d&&(c&&a.d(1),d())}),a.o(b))}function R(a){a&&a.c()}function L(a,b,c){let {fragment:d,on_mount:e,on_destroy:f,after_update:h}=a.$$;d&&d.m(b,c);za(()=>{let b=e.map(U).filter(Ya);f?f.push(...b):b.forEach(U);a.$$.on_mount=[]});h.forEach(za)}function M(a,b){a=a.$$;null!==a.fragment&&(a.on_destroy.forEach(U),a.fragment&&a.fragment.d(b),a.on_destroy=a.fragment=null,a.ctx=[])}
function I(a,b,c,d,e,f,h=[-1]){let k=N;N=a;let m=b.props||{},g=a.$$={fragment:null,ctx:null,props:f,update:v,not_equal:e,bound:Object.create(null),on_mount:[],on_destroy:[],before_update:[],after_update:[],context:new Map(k?k.$$.context:[]),callbacks:Object.create(null),dirty:h,skip_bound:!1},l=!1;g.ctx=c?c(a,m,(b,c,...d)=>{d=d.length?d[0]:c;if(g.ctx&&e(g.ctx[b],g.ctx[b]=d)){if(!g.skip_bound&&g.bound[b])g.bound[b](d);l&&(-1===a.$$.dirty[0]&&(ha.push(a),Ca||(Ca=!0,Kb.then(ab)),a.$$.dirty.fill(0)),
a.$$.dirty[b/31|0]|=1<<b%31)}return c}):[];g.update();l=!0;g.before_update.forEach(U);g.fragment=d?d(g.ctx):!1;b.target&&(b.hydrate?(c=Array.from(b.target.childNodes),g.fragment&&g.fragment.l(c),c.forEach(w)):g.fragment&&g.fragment.c(),b.intro&&n(a.$$.fragment),L(a,b.target,b.anchor),ab());N=k}function Lb(a){let b,c,d,e,f;return{c(){b=document.createElement("button");q(b,"aria-label",c=a[3]?a[3]:null);q(b,"class",d=`${a[1]||""} shepherd-button ${a[4]?"shepherd-button-secondary":""}`);b.disabled=a[2];
q(b,"tabindex","0")},m(c,d){c.insertBefore(b,d||null);b.innerHTML=a[5];e||(f=la(b,"click",function(){Ya(a[0])&&a[0].apply(this,arguments)}),e=!0)},p(e,[f]){a=e;f&32&&(b.innerHTML=a[5]);f&8&&c!==(c=a[3]?a[3]:null)&&q(b,"aria-label",c);f&18&&d!==(d=`${a[1]||""} shepherd-button ${a[4]?"shepherd-button-secondary":""}`)&&q(b,"class",d);f&4&&(b.disabled=a[2])},i:v,o:v,d(a){a&&w(b);e=!1;f()}}}function Mb(a,b,c){let {config:d}=b,{step:e}=b,f,h,k,m,g,l;a.$$set=a=>{"config"in a&&c(6,d=a.config);"step"in a&&
c(7,e=a.step)};a.$$.update=()=>{if(a.$$.dirty&192){c(0,f=d.action?d.action.bind(e.tour):null);c(1,h=d.classes);if(d.disabled){var b=d.disabled;b=T(b)?b.call(e):b}else b=!1;c(2,k=b);c(3,m=d.label);c(4,g=d.secondary);c(5,l=d.text)}};return[f,h,k,m,g,l,d,e]}function cb(a,b,c){a=a.slice();a[2]=b[c];return a}function db(a){let b,c,d=a[1],e=[];for(let b=0;b<d.length;b+=1)e[b]=eb(cb(a,d,b));let f=a=>r(e[a],1,1,()=>{e[a]=null});return{c(){for(let a=0;a<e.length;a+=1)e[a].c();b=document.createTextNode("")},
m(a,d){for(let b=0;b<e.length;b+=1)e[b].m(a,d);a.insertBefore(b,d||null);c=!0},p(a,c){if(c&3){d=a[1];let h;for(h=0;h<d.length;h+=1){let f=cb(a,d,h);e[h]?(e[h].p(f,c),n(e[h],1)):(e[h]=eb(f),e[h].c(),n(e[h],1),e[h].m(b.parentNode,b))}O();for(h=d.length;h<e.length;h+=1)f(h);Q()}},i(a){if(!c){for(a=0;a<d.length;a+=1)n(e[a]);c=!0}},o(a){e=e.filter(Boolean);for(a=0;a<e.length;a+=1)r(e[a]);c=!1},d(a){var c=e;for(let b=0;b<c.length;b+=1)c[b]&&c[b].d(a);a&&w(b)}}}function eb(a){let b,c;b=new Nb({props:{config:a[2],
step:a[0]}});return{c(){R(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&2&&(d.config=a[2]);c&1&&(d.step=a[0]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);c=!1},d(a){M(b,a)}}}function Ob(a){let b,c,d=a[1]&&db(a);return{c(){b=document.createElement("footer");d&&d.c();q(b,"class","shepherd-footer")},m(a,f){a.insertBefore(b,f||null);d&&d.m(b,null);c=!0},p(a,[c]){a[1]?d?(d.p(a,c),c&2&&n(d,1)):(d=db(a),d.c(),n(d,1),d.m(b,null)):d&&(O(),r(d,1,1,()=>{d=null}),Q())},i(a){c||
(n(d),c=!0)},o(a){r(d);c=!1},d(a){a&&w(b);d&&d.d()}}}function Pb(a,b,c){let {step:d}=b;a.$$set=a=>{"step"in a&&c(0,d=a.step)};let e;a.$$.update=()=>{a.$$.dirty&1&&c(1,e=d.options.buttons)};return[d,e]}function Qb(a){let b,c,d,e,f;return{c(){b=document.createElement("button");c=document.createElement("span");c.textContent="\u00d7";q(c,"aria-hidden","true");q(b,"aria-label",d=a[0].label?a[0].label:"Close Tour");q(b,"class","shepherd-cancel-icon");q(b,"type","button")},m(d,k){d.insertBefore(b,k||null);
b.appendChild(c);e||(f=la(b,"click",a[1]),e=!0)},p(a,[c]){c&1&&d!==(d=a[0].label?a[0].label:"Close Tour")&&q(b,"aria-label",d)},i:v,o:v,d(a){a&&w(b);e=!1;f()}}}function Rb(a,b,c){let {cancelIcon:d}=b,{step:e}=b;a.$$set=a=>{"cancelIcon"in a&&c(0,d=a.cancelIcon);"step"in a&&c(2,e=a.step)};return[d,a=>{a.preventDefault();e.cancel()},e]}function Sb(a){let b;return{c(){b=document.createElement("h3");q(b,"id",a[1]);q(b,"class","shepherd-title")},m(c,d){c.insertBefore(b,d||null);a[3](b)},p(a,[d]){d&2&&q(b,
"id",a[1])},i:v,o:v,d(c){c&&w(b);a[3](null)}}}function Tb(a,b,c){let {labelId:d}=b,{element:e}=b,{title:f}=b;ma().$$.after_update.push(()=>{T(f)&&c(2,f=f());c(0,e.innerHTML=f,e)});a.$$set=a=>{"labelId"in a&&c(1,d=a.labelId);"element"in a&&c(0,e=a.element);"title"in a&&c(2,f=a.title)};return[e,d,f,function(a){W[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}function fb(a){let b,c;b=new Ub({props:{labelId:a[0],title:a[2]}});return{c(){R(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&1&&(d.labelId=
a[0]);c&4&&(d.title=a[2]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);c=!1},d(a){M(b,a)}}}function gb(a){let b,c;b=new Vb({props:{cancelIcon:a[3],step:a[1]}});return{c(){R(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&8&&(d.cancelIcon=a[3]);c&2&&(d.step=a[1]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);c=!1},d(a){M(b,a)}}}function Wb(a){let b,c,d,e=a[2]&&fb(a),f=a[3]&&a[3].enabled&&gb(a);return{c(){b=document.createElement("header");e&&
e.c();c=document.createTextNode(" ");f&&f.c();q(b,"class","shepherd-header")},m(a,k){a.insertBefore(b,k||null);e&&e.m(b,null);b.appendChild(c);f&&f.m(b,null);d=!0},p(a,[d]){a[2]?e?(e.p(a,d),d&4&&n(e,1)):(e=fb(a),e.c(),n(e,1),e.m(b,c)):e&&(O(),r(e,1,1,()=>{e=null}),Q());a[3]&&a[3].enabled?f?(f.p(a,d),d&8&&n(f,1)):(f=gb(a),f.c(),n(f,1),f.m(b,null)):f&&(O(),r(f,1,1,()=>{f=null}),Q())},i(a){d||(n(e),n(f),d=!0)},o(a){r(e);r(f);d=!1},d(a){a&&w(b);e&&e.d();f&&f.d()}}}function Xb(a,b,c){let {labelId:d}=b,
{step:e}=b,f,h;a.$$set=a=>{"labelId"in a&&c(0,d=a.labelId);"step"in a&&c(1,e=a.step)};a.$$.update=()=>{a.$$.dirty&2&&(c(2,f=e.options.title),c(3,h=e.options.cancelIcon))};return[d,e,f,h]}function Yb(a){let b;return{c(){b=document.createElement("div");q(b,"class","shepherd-text");q(b,"id",a[1])},m(c,d){c.insertBefore(b,d||null);a[3](b)},p(a,[d]){d&2&&q(b,"id",a[1])},i:v,o:v,d(c){c&&w(b);a[3](null)}}}function Zb(a,b,c){let {descriptionId:d}=b,{element:e}=b,{step:f}=b;ma().$$.after_update.push(()=>{let {text:a}=
f.options;T(a)&&(a=a.call(f));a instanceof HTMLElement?e.appendChild(a):c(0,e.innerHTML=a,e)});a.$$set=a=>{"descriptionId"in a&&c(1,d=a.descriptionId);"element"in a&&c(0,e=a.element);"step"in a&&c(2,f=a.step)};return[e,d,f,function(a){W[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}function hb(a){let b,c;b=new $b({props:{labelId:a[1],step:a[2]}});return{c(){R(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&2&&(d.labelId=a[1]);c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,
a);c=!1},d(a){M(b,a)}}}function ib(a){let b,c;b=new ac({props:{descriptionId:a[0],step:a[2]}});return{c(){R(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&1&&(d.descriptionId=a[0]);c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);c=!1},d(a){M(b,a)}}}function jb(a){let b,c;b=new bc({props:{step:a[2]}});return{c(){R(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,
a);c=!1},d(a){M(b,a)}}}function cc(a){let b,c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled,d,e=void 0!==a[2].options.text,f,h=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length,k,m=c&&hb(a),g=e&&ib(a),l=h&&jb(a);return{c(){b=document.createElement("div");m&&m.c();d=document.createTextNode(" ");g&&g.c();f=document.createTextNode(" ");l&&l.c();q(b,"class","shepherd-content")},m(a,c){a.insertBefore(b,c||null);m&&m.m(b,null);b.appendChild(d);g&&g.m(b,
null);b.appendChild(f);l&&l.m(b,null);k=!0},p(a,[k]){k&4&&(c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled);c?m?(m.p(a,k),k&4&&n(m,1)):(m=hb(a),m.c(),n(m,1),m.m(b,d)):m&&(O(),r(m,1,1,()=>{m=null}),Q());k&4&&(e=void 0!==a[2].options.text);e?g?(g.p(a,k),k&4&&n(g,1)):(g=ib(a),g.c(),n(g,1),g.m(b,f)):g&&(O(),r(g,1,1,()=>{g=null}),Q());k&4&&(h=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length);h?l?(l.p(a,k),k&4&&n(l,1)):(l=jb(a),l.c(),n(l,1),l.m(b,
null)):l&&(O(),r(l,1,1,()=>{l=null}),Q())},i(a){k||(n(m),n(g),n(l),k=!0)},o(a){r(m);r(g);r(l);k=!1},d(a){a&&w(b);m&&m.d();g&&g.d();l&&l.d()}}}function dc(a,b,c){let {descriptionId:d}=b,{labelId:e}=b,{step:f}=b;a.$$set=a=>{"descriptionId"in a&&c(0,d=a.descriptionId);"labelId"in a&&c(1,e=a.labelId);"step"in a&&c(2,f=a.step)};return[d,e,f]}function kb(a){let b;return{c(){b=document.createElement("div");q(b,"class","shepherd-arrow");q(b,"data-popper-arrow","")},m(a,d){a.insertBefore(b,d||null)},d(a){a&&
w(b)}}}function ec(a){let b,c,d,e,f,h,k,m,g=a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element&&a[4].options.attachTo.on&&kb();d=new fc({props:{descriptionId:a[2],labelId:a[3],step:a[4]}});let l=[{"aria-describedby":e=void 0!==a[4].options.text?a[2]:null},{"aria-labelledby":f=a[4].options.title?a[3]:null},a[1],{role:"dialog"},{tabindex:"0"}],p={};for(let a=0;a<l.length;a+=1)p=Jb(p,l[a]);return{c(){b=document.createElement("div");g&&g.c();c=document.createTextNode(" ");R(d.$$.fragment);
$a(b,p);V(b,"shepherd-has-cancel-icon",a[5]);V(b,"shepherd-has-title",a[6]);V(b,"shepherd-element",!0)},m(e,f){e.insertBefore(b,f||null);g&&g.m(b,null);b.appendChild(c);L(d,b,null);a[13](b);h=!0;k||(m=la(b,"keydown",a[7]),k=!0)},p(a,[k]){a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element&&a[4].options.attachTo.on?g||(g=kb(),g.c(),g.m(b,c)):g&&(g.d(1),g=null);var m={};k&4&&(m.descriptionId=a[2]);k&8&&(m.labelId=a[3]);k&16&&(m.step=a[4]);d.$set(m);m=b;{k=[(!h||k&20&&e!==(e=void 0!==
a[4].options.text?a[2]:null))&&{"aria-describedby":e},(!h||k&24&&f!==(f=a[4].options.title?a[3]:null))&&{"aria-labelledby":f},k&2&&a[1],{role:"dialog"},{tabindex:"0"}];let b={},c={},d={$$scope:1},g=l.length;for(;g--;){let a=l[g],e=k[g];if(e){for(u in a)u in e||(c[u]=1);for(let a in e)d[a]||(b[a]=e[a],d[a]=1);l[g]=e}else for(let b in a)d[b]=1}for(let a in c)a in b||(b[a]=void 0);var u=b}$a(m,p=u);V(b,"shepherd-has-cancel-icon",a[5]);V(b,"shepherd-has-title",a[6]);V(b,"shepherd-element",!0)},i(a){h||
(n(d.$$.fragment,a),h=!0)},o(a){r(d.$$.fragment,a);h=!1},d(c){c&&w(b);g&&g.d();M(d);a[13](null);k=!1;m()}}}function lb(a){return a.split(" ").filter(a=>!!a.length)}function gc(a,b,c){let {classPrefix:d}=b,{element:e}=b,{descriptionId:f}=b,{firstFocusableElement:h}=b,{focusableElements:k}=b,{labelId:m}=b,{lastFocusableElement:g}=b,{step:l}=b,{dataStepId:p}=b,t,z,A;ma().$$.on_mount.push(()=>{c(1,p={[`data-${d}shepherd-step-id`]:l.id});c(9,k=e.querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex="0"]'));
...
a&&c(10,g=a.lastFocusableElement);"step"in a&&c(4,l=a.step);"dataStepId"in a&&c(1,p=a.dataStepId)};a.$$.update=()=>{a.$$.dirty&16&&(c(5,t=l.options&&l.options.cancelIcon&&l.options.cancelIcon.enabled),c(6,z=l.options&&l.options.title))};return[e,p,f,m,l,t,z,a=>{const {tour:b}=l;switch(a.keyCode){case 9:if(0===k.length){a.preventDefault();break}if(a.shiftKey){if(document.activeElement===h||document.activeElement.classList.contains("shepherd-element"))a.preventDefault(),g.focus()}else document.activeElement===
...
g,{x:m,width:z,left:p}=a.getBoundingClientRect();c(4,l={width:z+2*d,height:k+2*d,x:(m||p)-d,y:h-d,r:e})}}function h(){c(1,p=!0)}function k(){t&&(cancelAnimationFrame(t),t=void 0);window.removeEventListener("touchmove",A,{passive:!1})}function m(a){let {modalOverlayOpeningPadding:b,modalOverlayOpeningRadius:c}=a.options;if(a.target){let d=mb(a.target),e=()=>{t=void 0;f(a.target,d,b,c);t=requestAnimationFrame(e)};e();window.addEventListener("touchmove",A,{passive:!1})}else d()}let {element:g}=b,{openingProperties:l}=
b;ya();let p=!1,t=void 0,z;d();let A=a=>{a.preventDefault()};a.$$set=a=>{"element"in a&&c(0,g=a.element);"openingProperties"in a&&c(4,l=a.openingProperties)};a.$$.update=()=>{a.$$.dirty&16&&c(2,z=ic(l))};return[g,p,z,a=>{a.stopPropagation()},l,()=>g,d,e,f,function(a){k();a.tour.options.useModalOverlay?(m(a),h()):e()},h,function(a){W[a?"unshift":"push"](()=>{g=a;c(0,g)})}]}var qb=function(a){var b;if(b=!!a&&"object"===typeof a)b=Object.prototype.toString.call(a),b=!("[object RegExp]"===b||"[object Date]"===
...
fn:function(){},effect:function(a){var b=a.state,c=a.instance;a=a.options;var d=a.scroll,e=void 0===d?!0:d;a=a.resize;var f=void 0===a?!0:a,h=y(b.elements.popper),k=[].concat(b.scrollParents.reference,b.scrollParents.popper);e&&k.forEach(function(a){a.addEventListener("scroll",c.update,pa)});f&&h.addEventListener("resize",c.update,pa);return function(){e&&k.forEach(function(a){a.removeEventListener("scroll",c.update,pa)});f&&h.removeEventListener("resize",c.update,pa)}},data:{}},{name:"popperOffsets",
...
a.classList.remove("shepherd-target-click-disabled",`${this.classPrefix}shepherd-enabled`,`${this.classPrefix}shepherd-target`)}}class pc extends K{constructor(a){super();I(this,a,kc,jc,H,{element:0,openingProperties:4,getElement:5,closeModalOpening:6,hide:7,positionModalOpening:8,setupForStep:9,show:10})}get getElement(){return this.$$.ctx[5]}get closeModalOpening(){return this.$$.ctx[6]}get hide(){return this.$$.ctx[7]}get positionModalOpening(){return this.$$.ctx[8]}get setupForStep(){return this.$$.ctx[9]}get show(){return this.$$.ctx[10]}}
