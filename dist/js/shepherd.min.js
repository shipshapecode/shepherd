...
padding:e})[F(f)];return b},{});return Object.keys(g).sort(function(a,b){return g[a]-g[b]})}function Bb(a){if("auto"===F(a))return[];var b=ka(a);return[Ma(a),b,Ma(b)]}function Ta(a,b,c){void 0===c&&(c={x:0,y:0});return{top:a.top-b.height-c.y,right:a.right-b.width+c.x,bottom:a.bottom-b.height+c.y,left:a.left-b.width-c.x}}function Ua(a){return["top","right","bottom","left"].some(function(b){return 0<=a[b]})}function Cb(){return[{name:"applyStyles",fn:function(a){var b=a.state;Object.keys(b.elements).forEach(function(a){if("popper"===
a){var c=b.attributes[a]||{},e=b.elements[a];Object.assign(e.style,{position:"fixed",left:"50%",top:"50%",transform:"translate(-50%, -50%)"});Object.keys(c).forEach(function(a){var b=c[a];!1===b?e.removeAttribute(a):e.setAttribute(a,!0===b?"":b)})}})}},{name:"computeStyles",options:{adaptive:!1}}]}function Db(a){var b=Cb(),c=a.shepherdElementComponent.getElement();a=Eb(a);c.classList.add("shepherd-centered");return a=ra({},a,{modifiers:Array.from(new Set([].concat(a.modifiers,b)))})}function Eb(a){return{placement:"top",
...
16|0;a=Math.floor(a/16);return("x"==b?c:c&3|8).toString(16)})}function Fb(a,b){var c={modifiers:[{name:"preventOverflow",options:{altAxis:!0}}],strategy:"absolute",onFirstUpdate:function(){b.el.focus()}},d=document.body;a.element&&a.on?(c.placement=a.on||"right",d=a.element):c=Db(b);(a=b.tour&&b.tour.options&&b.tour.options.defaultStepOptions)&&(c=Xa(a,c));c=Xa(b.options,c);return{element:b.el,popperOptions:c,target:d}}function Xa(a,b){if(a.popperOptions){if(a.popperOptions.modifiers&&0<a.popperOptions.modifiers.length){var c=
a.popperOptions.modifiers.map(function(a){return a.name}),d=b.modifiers.filter(function(a){return!c.includes(a.name)});b.modifiers=Array.from(new Set([].concat(d,a.popperOptions.modifiers)))}b=Object.assign(a.popperOptions,b)}return b}function A(){}function Gb(a,b){for(var c in b)a[c]=b[c];return a}function U(a){return a()}function Ya(a){return"function"===typeof a}function H(a,b){return a!=a?b==b:a!==b||a&&"object"===typeof a||"function"===typeof a}function B(a){a.parentNode.removeChild(a)}function Za(a){return document.createElementNS("http://www.w3.org/2000/svg",
...
function Jb(a,b,c){var d=b.config,e=b.step,f,h,k,m,g,l;a.$set=function(a){"config"in a&&c(6,d=a.config);"step"in a&&c(7,e=a.step)};a.$$.update=function(){if(a.$$.dirty&192){c(0,f=d.action?d.action.bind(e.tour):null);c(1,h=d.classes);c(2,k=d.secondary);c(3,m=d.text);c(4,g=d.label);if(d.disabled){var b=d.disabled;b=T(b)?b.call(e):b}else b=!1;c(5,l=b)}};return[f,h,k,m,g,l,d,e]}function cb(a,b,c){a=a.slice();a[2]=b[c];return a}function db(a){for(var b,c,d=a[1],e=[],f=0;f<d.length;f+=1)e[f]=eb(cb(a,d,
f));var h=function(a){return v(e[a],1,1,function(){e[a]=null})};return{c:function(){for(var a=0;a<e.length;a+=1)e[a].c();b=document.createTextNode("")},m:function(a,d){for(var f=0;f<e.length;f+=1)e[f].m(a,d);a.insertBefore(b,d||null);c=!0},p:function(a,c){if(c&3){d=a[1];var f;for(f=0;f<d.length;f+=1){var k=cb(a,d,f);e[f]?(e[f].p(k,c),p(e[f],1)):(e[f]=eb(k),e[f].c(),p(e[f],1),e[f].m(b.parentNode,b))}N();for(f=d.length;f<e.length;f+=1)h(f);P()}},i:function(a){if(!c){for(a=0;a<d.length;a+=1)p(e[a]);
c=!0}},o:function(a){e=e.filter(Boolean);for(a=0;a<e.length;a+=1)v(e[a]);c=!1},d:function(a){for(var c=e,d=0;d<c.length;d+=1)c[d]&&c[d].d(a);a&&B(b)}}}function eb(a){var b,c=new Kb({props:{config:a[2],step:a[0]}});return{c:function(){Q(c.$$.fragment)},m:function(a,e){L(c,a,e);b=!0},p:function(a,b){var d={};b&2&&(d.config=a[2]);b&1&&(d.step=a[0]);c.$set(d)},i:function(a){b||(p(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){M(c,a)}}}function Lb(a){var b,c,d=a[1]&&db(a);
return{c:function(){b=document.createElement("footer");d&&d.c();t(b,"class","shepherd-footer")},m:function(a,f){a.insertBefore(b,f||null);d&&d.m(b,null);c=!0},p:function(a,c){c=c[0];a[1]?d?(d.p(a,c),c&2&&p(d,1)):(d=db(a),d.c(),p(d,1),d.m(b,null)):d&&(N(),v(d,1,1,function(){d=null}),P())},i:function(a){c||(p(d),c=!0)},o:function(a){v(d);c=!1},d:function(a){a&&B(b);d&&d.d()}}}function Mb(a,b,c){var d=b.step;a.$set=function(a){"step"in a&&c(0,d=a.step)};var e;a.$$.update=function(){a.$$.dirty&1&&c(1,
e=d.options.buttons)};return[d,e]}function Nb(a){var b,c,d,e;return{c:function(){b=document.createElement("button");c=document.createElement("span");c.textContent="\u00d7";t(c,"aria-hidden","true");t(b,"aria-label",d=a[0].label?a[0].label:"Close Tour");t(b,"class","shepherd-cancel-icon");t(b,"type","button")},m:function(d,h,k){d.insertBefore(b,h||null);b.appendChild(c);k&&e();e=la(b,"click",a[1])},p:function(a,c){c[0]&1&&d!==(d=a[0].label?a[0].label:"Close Tour")&&t(b,"aria-label",d)},i:A,o:A,d:function(a){a&&
B(b);e()}}}function Ob(a,b,c){var d=b.cancelIcon,e=b.step;a.$set=function(a){"cancelIcon"in a&&c(0,d=a.cancelIcon);"step"in a&&c(2,e=a.step)};return[d,function(a){a.preventDefault();e.cancel()},e]}function Pb(a){var b;return{c:function(){b=document.createElement("h3");t(b,"id",a[1]);t(b,"class","shepherd-title")},m:function(c,d){c.insertBefore(b,d||null);a[3](b)},p:function(a,d){d[0]&2&&t(b,"id",a[1])},i:A,o:A,d:function(c){c&&B(b);a[3](null)}}}function Qb(a,b,c){var d=b.labelId,e=b.element,f=b.title;
ma().$$.after_update.push(function(){T(f)&&c(2,f=f());c(0,e.innerHTML=f,e)});a.$set=function(a){"labelId"in a&&c(1,d=a.labelId);"element"in a&&c(0,e=a.element);"title"in a&&c(2,f=a.title)};return[e,d,f,function(a){X[a?"unshift":"push"](function(){c(0,e=a)})}]}function fb(a){var b,c=new Rb({props:{labelId:a[0],title:a[2]}});return{c:function(){Q(c.$$.fragment)},m:function(a,e){L(c,a,e);b=!0},p:function(a,b){var d={};b&1&&(d.labelId=a[0]);b&4&&(d.title=a[2]);c.$set(d)},i:function(a){b||(p(c.$$.fragment,
a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){M(c,a)}}}function gb(a){var b,c=new Sb({props:{cancelIcon:a[3],step:a[1]}});return{c:function(){Q(c.$$.fragment)},m:function(a,e){L(c,a,e);b=!0},p:function(a,b){var d={};b&8&&(d.cancelIcon=a[3]);b&2&&(d.step=a[1]);c.$set(d)},i:function(a){b||(p(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){M(c,a)}}}function Tb(a){var b,c,d,e=a[2]&&fb(a),f=a[3]&&a[3].enabled&&gb(a);return{c:function(){b=document.createElement("header");
e&&e.c();c=document.createTextNode(" ");f&&f.c();t(b,"class","shepherd-header")},m:function(a,k){a.insertBefore(b,k||null);e&&e.m(b,null);b.appendChild(c);f&&f.m(b,null);d=!0},p:function(a,d){d=d[0];a[2]?e?(e.p(a,d),d&4&&p(e,1)):(e=fb(a),e.c(),p(e,1),e.m(b,c)):e&&(N(),v(e,1,1,function(){e=null}),P());a[3]&&a[3].enabled?f?(f.p(a,d),d&8&&p(f,1)):(f=gb(a),f.c(),p(f,1),f.m(b,null)):f&&(N(),v(f,1,1,function(){f=null}),P())},i:function(a){d||(p(e),p(f),d=!0)},o:function(a){v(e);v(f);d=!1},d:function(a){a&&
B(b);e&&e.d();f&&f.d()}}}function Ub(a,b,c){var d=b.labelId,e=b.step,f,h;a.$set=function(a){"labelId"in a&&c(0,d=a.labelId);"step"in a&&c(1,e=a.step)};a.$$.update=function(){a.$$.dirty&2&&(c(2,f=e.options.title),c(3,h=e.options.cancelIcon))};return[d,e,f,h]}function Vb(a){var b;return{c:function(){b=document.createElement("div");t(b,"class","shepherd-text");t(b,"id",a[1])},m:function(c,d){c.insertBefore(b,d||null);a[3](b)},p:function(a,d){d[0]&2&&t(b,"id",a[1])},i:A,o:A,d:function(c){c&&B(b);a[3](null)}}}
function Wb(a,b,c){var d=b.descriptionId,e=b.element,f=b.step;ma().$$.after_update.push(function(){var a=f.options.text;T(a)&&(a=a.call(f));a instanceof HTMLElement?e.appendChild(a):c(0,e.innerHTML=a,e)});a.$set=function(a){"descriptionId"in a&&c(1,d=a.descriptionId);"element"in a&&c(0,e=a.element);"step"in a&&c(2,f=a.step)};return[e,d,f,function(a){X[a?"unshift":"push"](function(){c(0,e=a)})}]}function hb(a){var b,c=new Xb({props:{labelId:a[1],step:a[2]}});return{c:function(){Q(c.$$.fragment)},m:function(a,
e){L(c,a,e);b=!0},p:function(a,b){var d={};b&2&&(d.labelId=a[1]);b&4&&(d.step=a[2]);c.$set(d)},i:function(a){b||(p(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){M(c,a)}}}function ib(a){var b,c=new Yb({props:{descriptionId:a[0],step:a[2]}});return{c:function(){Q(c.$$.fragment)},m:function(a,e){L(c,a,e);b=!0},p:function(a,b){var d={};b&1&&(d.descriptionId=a[0]);b&4&&(d.step=a[2]);c.$set(d)},i:function(a){b||(p(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=
!1},d:function(a){M(c,a)}}}function jb(a){var b,c=new Zb({props:{step:a[2]}});return{c:function(){Q(c.$$.fragment)},m:function(a,e){L(c,a,e);b=!0},p:function(a,b){var d={};b&4&&(d.step=a[2]);c.$set(d)},i:function(a){b||(p(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){M(c,a)}}}function $b(a){var b,c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled,d,e=void 0!==a[2].options.text,f,h=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length,
k,m=c&&hb(a),g=e&&ib(a),l=h&&jb(a);return{c:function(){b=document.createElement("div");m&&m.c();d=document.createTextNode(" ");g&&g.c();f=document.createTextNode(" ");l&&l.c();t(b,"class","shepherd-content")},m:function(a,c){a.insertBefore(b,c||null);m&&m.m(b,null);b.appendChild(d);g&&g.m(b,null);b.appendChild(f);l&&l.m(b,null);k=!0},p:function(a,k){k=k[0];k&4&&(c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled);c?m?(m.p(a,k),k&4&&p(m,1)):(m=hb(a),m.c(),p(m,1),
m.m(b,d)):m&&(N(),v(m,1,1,function(){m=null}),P());k&4&&(e=void 0!==a[2].options.text);e?g?(g.p(a,k),k&4&&p(g,1)):(g=ib(a),g.c(),p(g,1),g.m(b,f)):g&&(N(),v(g,1,1,function(){g=null}),P());k&4&&(h=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length);h?l?(l.p(a,k),k&4&&p(l,1)):(l=jb(a),l.c(),p(l,1),l.m(b,null)):l&&(N(),v(l,1,1,function(){l=null}),P())},i:function(a){k||(p(m),p(g),p(l),k=!0)},o:function(a){v(m);v(g);v(l);k=!1},d:function(a){a&&B(b);m&&m.d();g&&g.d();l&&l.d()}}}function ac(a,
b,c){var d=b.descriptionId,e=b.labelId,f=b.step;a.$set=function(a){"descriptionId"in a&&c(0,d=a.descriptionId);"labelId"in a&&c(1,e=a.labelId);"step"in a&&c(2,f=a.step)};return[d,e,f]}function kb(a){var b;return{c:function(){b=document.createElement("div");t(b,"class","shepherd-arrow");t(b,"data-popper-arrow","")},m:function(a,d){a.insertBefore(b,d||null)},d:function(a){a&&B(b)}}}function bc(a){for(var b,c,d,e,f=a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element&&kb(),h=new cc({props:{descriptionId:a[2],
...
b,null);a[17](b);d=!0;m&&e();e=la(b,"keydown",a[7])},p:function(a,d){var e=d[0];a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element?f||(f=kb(),f.c(),f.m(b,c)):f&&(f.d(1),f=null);d={};e&4&&(d.descriptionId=a[2]);e&8&&(d.labelId=a[3]);e&16&&(d.step=a[4]);h.$set(d);d=b;e=[e&20&&{"aria-describedby":void 0!==a[4].options.text?a[2]:null},e&24&&{"aria-labelledby":a[4].options.title?a[3]:null},e&2&&a[1],{role:"dialog"},{tabindex:"0"}];for(var g={},m={},r={$$scope:1},y=k.length;y--;){var l=
k[y],ja=e[y];if(ja){for(var n in l)n in ja||(m[n]=1);for(var pa in ja)r[pa]||(g[pa]=ja[pa],r[pa]=1);k[y]=ja}else for(var p in l)r[p]=1}for(var t in m)t in g||(g[t]=void 0);$a(d,g);V(b,"shepherd-has-cancel-icon",a[5]);V(b,"shepherd-has-title",a[6]);V(b,"shepherd-element",!0)},i:function(a){d||(p(h.$$.fragment,a),d=!0)},o:function(a){v(h.$$.fragment,a);d=!1},d:function(c){c&&B(b);f&&f.d();M(h);a[17](null);e()}}}function lb(a){return a.split(" ").filter(function(a){return!!a.length})}function ec(a,b,
c){function d(){e(x);x=q.options.classes;f(x)}function e(a){if(Z(a)&&(a=lb(a),a.length)){var b;(b=k.classList).remove.apply(b,a)}}function f(a){if(Z(a)&&(a=lb(a),a.length)){var b;(b=k.classList).add.apply(b,a)}}var h=b.classPrefix,k=b.element,m=b.descriptionId,g=b.firstFocusableElement,l=b.focusableElements,n=b.labelId,u=b.lastFocusableElement,q=b.step,D=b.dataStepId,r,y,x;ma().$$.on_mount.push(function(){var a;c(1,D=(a={},a["data-"+h+"shepherd-step-id"]=q.id,a));c(9,l=k.querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex="0"]'));
...
function m(){q&&(cancelAnimationFrame(q),q=void 0);window.removeEventListener("touchmove",r,{passive:!1})}function g(a){var b=a.options,c=b.modalOverlayOpeningPadding,e=b.modalOverlayOpeningRadius;if(a.target){var g=mb(a.target);(function dc(){q=void 0;f(a.target,g,c,e);q=requestAnimationFrame(dc)})();k()}else d()}var l=b.element,n=b.openingProperties;b=wa();var u=!1,q=void 0,D;d();var r=function(a){a.preventDefault()};a.$set=function(a){"element"in a&&c(0,l=a.element);"openingProperties"in a&&c(4,
...
b+"-end"])},[]),Ra=[].concat(ha,["auto"]).reduce(function(a,b){return a.concat([b,b+"-start",b+"-end"])},[]),sb="beforeRead read afterRead beforeMain main afterMain beforeWrite write afterWrite".split(" "),nb={placement:"bottom",modifiers:[],strategy:"absolute"},qa={passive:!0},vb={top:"auto",right:"auto",bottom:"auto",left:"auto"},wb={left:"right",right:"left",bottom:"top",top:"bottom"},xb={start:"end",end:"start"},ic=function(a){void 0===a&&(a={});var b=a.defaultModifiers,c=void 0===b?[]:b;a=a.defaultOptions;
...
Object.assign({},a.data)}),b=0;b<g.orderedModifiers.length;b++)if(!0===g.reset)g.reset=!1,b=-1;else{var c=g.orderedModifiers[b];a=c.fn;var d=c.options;d=void 0===d?{}:d;c=c.name;"function"===typeof a&&(g=a({state:g,options:d,name:c,instance:u})||g)}}},update:tb(function(){return new Promise(function(a){u.forceUpdate();a(g)})}),destroy:function(){f();n=!0}};if(!Ja(a,b))return u;u.setOptions(h).then(function(a){if(!n&&h.onFirstUpdate)h.onFirstUpdate(a)});return u}}({defaultModifiers:[{name:"eventListeners",
...
W,ia=[],X=[],na=[],bb=[],Hb=Promise.resolve(),Aa=!1,ya=!1,za=new Set,oa=new Set,O,J=function(){function a(){}var b=a.prototype;b.$destroy=function(){M(this,1);this.$destroy=A};b.$on=function(a,b){var c=this.$$.callbacks[a]||(this.$$.callbacks[a]=[]);c.push(b);return function(){var a=c.indexOf(b);-1!==a&&c.splice(a,1)}};b.$set=function(){};return a}(),Kb=function(a){function b(b){var c=a.call(this)||this;I(w(c),b,Jb,Ib,H,{config:6,step:7});return c}C(b,a);return b}(J),Zb=function(a){function b(b){var c=
a.call(this)||this;I(w(c),b,Mb,Lb,H,{step:0});return c}C(b,a);return b}(J),Sb=function(a){function b(b){var c=a.call(this)||this;I(w(c),b,Ob,Nb,H,{cancelIcon:0,step:2});return c}C(b,a);return b}(J),Rb=function(a){function b(b){var c=a.call(this)||this;I(w(c),b,Qb,Pb,H,{labelId:1,element:0,title:2});return c}C(b,a);return b}(J),Xb=function(a){function b(b){var c=a.call(this)||this;I(w(c),b,Ub,Tb,H,{labelId:0,step:1});return c}C(b,a);return b}(J),Yb=function(a){function b(b){var c=a.call(this)||this;
I(w(c),b,Wb,Vb,H,{descriptionId:1,element:0,step:2});return c}C(b,a);return b}(J),cc=function(a){function b(b){var c=a.call(this)||this;I(w(c),b,ac,$b,H,{descriptionId:0,labelId:1,step:2});return c}C(b,a);return b}(J),jc=function(a){function b(b){var c=a.call(this)||this;I(w(c),b,ec,bc,H,{classPrefix:11,element:0,descriptionId:2,firstFocusableElement:8,focusableElements:9,labelId:3,lastFocusableElement:10,step:4,dataStepId:1,getElement:12});return c}C(b,a);S(b,[{key:"getElement",get:function(){return this.$$.ctx[12]}}]);
...
this.tour&&this.tour.options&&this.tour.options.defaultStepOptions;b=b&&b.classes?b.classes:"";a=[].concat((a.classes?a.classes:"").split(" "),b.split(" "));a=new Set(a);return Array.from(a).join(" ").trim()};c._setOptions=function(a){var b=this;void 0===a&&(a={});var c=this.tour&&this.tour.options&&this.tour.options.defaultStepOptions;c=c?JSON.parse(JSON.stringify(c)):{};this.options=Object.assign({arrow:!0},c,a);var d=this.options.when;this.options.classes=this._getClassOptions(a);this.destroy();
this.id=this.options.id||"step-"+wa();d&&Object.keys(d).forEach(function(a){b.on(a,d[a],b)})};c._setupElements=function(){void 0!==this.el&&this.destroy();this.el=this._createTooltipContent();this.options.advanceOn&&pb(this);this.tooltip&&this.tooltip.destroy();var a=Wa(this),b=Fb(a,this);this.tooltip=ic(b.target,b.element,b.popperOptions);this.target=a.element};c._show=function(){var a=this;this.trigger("before-show");this._setupElements();this.tour.modal||this.tour._setupModal();this.tour.modal.setupForStep(this);
...
!1===a.options.canClickTarget&&b.classList.add("shepherd-target-click-disabled"))};c._updateStepTargetOnHide=function(){this.options.highlightClass&&this.target.classList.remove(this.options.highlightClass);this.target.classList.remove(this.classPrefix+"shepherd-enabled",this.classPrefix+"shepherd-target")};return b}(Ba),kc=function(a){function b(b){var c=a.call(this)||this;I(w(c),b,hc,gc,H,{element:0,openingProperties:4,getElement:5,closeModalOpening:6,hide:7,positionModalOpening:8,setupForStep:9,
show:10});return c}C(b,a);S(b,[{key:"getElement",get:function(){return this.$$.ctx[5]}},{key:"closeModalOpening",get:function(){return this.$$.ctx[6]}},{key:"hide",get:function(){return this.$$.ctx[7]}},{key:"positionModalOpening",get:function(){return this.$$.ctx[8]}},{key:"setupForStep",get:function(){return this.$$.ctx[9]}},{key:"show",get:function(){return this.$$.ctx[10]}}]);return b}(J),Y=new Ba,lc=function(a){function b(b){void 0===b&&(b={});var c=a.call(this,b)||this;Da(w(c));c.options=Object.assign({},
{exitOnEsc:!0,keyboardNavigation:!0},b);c.classPrefix=Va(c.options.classPrefix);c.steps=[];c.addSteps(c.options.steps);"active cancel complete inactive show start".split(" ").map(function(a){(function(a){c.on(a,function(b){b=b||{};b.tour=w(c);Y.trigger(a,b)})})(a)});c._setTourID();return w(c)||w(c)}C(b,a);var c=b.prototype;c.addStep=function(a,b){a instanceof Ca?a.tour=this:a=new Ca(this,a);void 0!==b?this.steps.splice(b,0,a):this.steps.push(a);return a};c.addSteps=function(a){var b=this;Array.isArray(a)&&
a.forEach(function(a){b.addStep(a)});return this};c.back=function(){var a=this.steps.indexOf(this.currentStep);this.show(a-1,!1)};c.cancel=function(){this.options.confirmCancel?window.confirm(this.options.confirmCancelMessage||"Are you sure you want to stop the tour?")&&this._done("cancel"):this._done("cancel")};c.complete=function(){this._done("complete")};c.getById=function(a){return this.steps.find(function(b){return b.id===a})};c.getCurrentStep=function(){return this.currentStep};c.hide=function(){var a=
this.getCurrentStep();if(a)return a.hide()};c.isActive=function(){return Y.activeTour===this};c.next=function(){var a=this.steps.indexOf(this.currentStep);a===this.steps.length-1?this.complete():this.show(a+1,!0)};c.removeStep=function(a){var b=this,c=this.getCurrentStep();this.steps.some(function(c,d){if(c.id===a)return c.isOpen()&&c.hide(),c.destroy(),b.steps.splice(d,1),!0});c&&c.id===a&&(this.currentStep=void 0,this.steps.length?this.show(0):this.cancel())};c.show=function(a,b){void 0===a&&(a=
0);void 0===b&&(b=!0);if(a=Z(a)?this.getById(a):this.steps[a])this._updateStateBeforeShow(),T(a.options.showOn)&&!a.options.showOn()?this._skipStep(a,b):(this.trigger("show",{step:a,previous:this.currentStep}),this.currentStep=a,a.show())};c.start=function(){this.trigger("start");this.focusedElBeforeOpen=document.activeElement;this.currentStep=null;this._setupModal();this._setupActiveTour();this.next()};c._done=function(a){var b=this.steps.indexOf(this.currentStep);Array.isArray(this.steps)&&this.steps.forEach(function(a){return a.destroy()});
fc(this);this.trigger(a,{index:b});Y.activeTour=null;this.trigger("inactive",{tour:this});this.modal&&this.modal.hide();"cancel"!==a&&"complete"!==a||!this.modal||(a=document.querySelector(".shepherd-modal-overlay-container"))&&a.remove();this.focusedElBeforeOpen instanceof HTMLElement&&this.focusedElBeforeOpen.focus()};c._setupActiveTour=function(){this.trigger("active",{tour:this});Y.activeTour=this};c._setupModal=function(){this.modal=new kc({target:this.options.modalContainer||document.body,props:{classPrefix:this.classPrefix,
styles:this.styles}})};c._skipStep=function(a,b){a=this.steps.indexOf(a);this.show(b?a+1:a-1,b)};c._updateStateBeforeShow=function(){this.currentStep&&this.currentStep.hide();this.isActive()||this._setupActiveTour()};c._setTourID=function(){this.id=(this.options.tourName||"tour")+"--"+wa()};return b}(Ba);Object.assign(Y,{Tour:lc,Step:Ca});return Y})
