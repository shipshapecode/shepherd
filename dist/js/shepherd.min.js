...
a[3](null)}}}function Tb(a,b,c){let {labelId:d}=b,{element:e}=b,{title:f}=b;ma().$$.after_update.push(()=>{S(f)&&c(2,f=f());c(0,e.innerHTML=f,e)});a.$$set=a=>{"labelId"in a&&c(1,d=a.labelId);"element"in a&&c(0,e=a.element);"title"in a&&c(2,f=a.title)};return[e,d,f,function(a){W[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}function fb(a){let b,c;b=new Ub({props:{labelId:a[0],title:a[2]}});return{c(){Q(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&1&&(d.labelId=a[0]);c&4&&(d.title=a[2]);b.$set(d)},
...
f&&f.c();q(b,"class","shepherd-header")},m(a,k){a.insertBefore(b,k||null);e&&e.m(b,null);b.appendChild(c);f&&f.m(b,null);d=!0},p(a,[d]){a[2]?e?(e.p(a,d),d&4&&n(e,1)):(e=fb(a),e.c(),n(e,1),e.m(b,c)):e&&(N(),r(e,1,1,()=>{e=null}),P());a[3]&&a[3].enabled?f?(f.p(a,d),d&8&&n(f,1)):(f=gb(a),f.c(),n(f,1),f.m(b,null)):f&&(N(),r(f,1,1,()=>{f=null}),P())},i(a){d||(n(e),n(f),d=!0)},o(a){r(e);r(f);d=!1},d(a){a&&w(b);e&&e.d();f&&f.d()}}}function Xb(a,b,c){let {labelId:d}=b,{step:e}=b,f,h;a.$$set=a=>{"labelId"in
a&&c(0,d=a.labelId);"step"in a&&c(1,e=a.step)};a.$$.update=()=>{a.$$.dirty&2&&(c(2,f=e.options.title),c(3,h=e.options.cancelIcon))};return[d,e,f,h]}function Yb(a){let b;return{c(){b=document.createElement("div");q(b,"class","shepherd-text");q(b,"id",a[1])},m(c,d){c.insertBefore(b,d||null);a[3](b)},p(a,[d]){d&2&&q(b,"id",a[1])},i:v,o:v,d(c){c&&w(b);a[3](null)}}}function Zb(a,b,c){let {descriptionId:d}=b,{element:e}=b,{step:f}=b;ma().$$.after_update.push(()=>{let {text:a}=f.options;S(a)&&(a=a.call(f));
a instanceof HTMLElement?e.appendChild(a):c(0,e.innerHTML=a,e)});a.$$set=a=>{"descriptionId"in a&&c(1,d=a.descriptionId);"element"in a&&c(0,e=a.element);"step"in a&&c(2,f=a.step)};return[e,d,f,function(a){W[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}function hb(a){let b,c;b=new $b({props:{labelId:a[1],step:a[2]}});return{c(){Q(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&2&&(d.labelId=a[1]);c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);c=!1},d(a){M(b,
a)}}}function ib(a){let b,c;b=new ac({props:{descriptionId:a[0],step:a[2]}});return{c(){Q(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&1&&(d.descriptionId=a[0]);c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);c=!1},d(a){M(b,a)}}}function jb(a){let b,c;b=new bc({props:{step:a[2]}});return{c(){Q(b.$$.fragment)},m(a,e){L(b,a,e);c=!0},p(a,c){let d={};c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(n(b.$$.fragment,a),c=!0)},o(a){r(b.$$.fragment,a);c=!1},d(a){M(b,
...
l&&l.m(b,null);k=!0},p(a,[k]){k&4&&(c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled);c?m?(m.p(a,k),k&4&&n(m,1)):(m=hb(a),m.c(),n(m,1),m.m(b,d)):m&&(N(),r(m,1,1,()=>{m=null}),P());k&4&&(e=void 0!==a[2].options.text);e?g?(g.p(a,k),k&4&&n(g,1)):(g=ib(a),g.c(),n(g,1),g.m(b,f)):g&&(N(),r(g,1,1,()=>{g=null}),P());k&4&&(h=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length);h?l?(l.p(a,k),k&4&&n(l,1)):(l=jb(a),l.c(),n(l,1),l.m(b,null)):l&&(N(),r(l,1,1,
()=>{l=null}),P())},i(a){k||(n(m),n(g),n(l),k=!0)},o(a){r(m);r(g);r(l);k=!1},d(a){a&&w(b);m&&m.d();g&&g.d();l&&l.d()}}}function dc(a,b,c){let {descriptionId:d}=b,{labelId:e}=b,{step:f}=b;a.$$set=a=>{"descriptionId"in a&&c(0,d=a.descriptionId);"labelId"in a&&c(1,e=a.labelId);"step"in a&&c(2,f=a.step)};return[d,e,f]}function kb(a){let b;return{c(){b=document.createElement("div");q(b,"class","shepherd-arrow");q(b,"data-popper-arrow","")},m(a,d){a.insertBefore(b,d||null)},d(a){a&&w(b)}}}function ec(a){let b,
c,d,e,f,h,k,m,g=a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element&&a[4].options.attachTo.on&&kb();d=new fc({props:{descriptionId:a[2],labelId:a[3],step:a[4]}});let l=[{"aria-describedby":e=void 0!==a[4].options.text?a[2]:null},{"aria-labelledby":f=a[4].options.title?a[3]:null},a[1],{role:"dialog"},{tabindex:"0"}],p={};for(let a=0;a<l.length;a+=1)p=Jb(p,l[a]);return{c(){b=document.createElement("div");g&&g.c();c=document.createTextNode(" ");Q(d.$$.fragment);$a(b,p);U(b,"shepherd-has-cancel-icon",
a[5]);U(b,"shepherd-has-title",a[6]);U(b,"shepherd-element",!0)},m(e,f){e.insertBefore(b,f||null);g&&g.m(b,null);b.appendChild(c);L(d,b,null);a[13](b);h=!0;k||(m=la(b,"keydown",a[7]),k=!0)},p(a,[k]){a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element&&a[4].options.attachTo.on?g||(g=kb(),g.c(),g.m(b,c)):g&&(g.d(1),g=null);var m={};k&4&&(m.descriptionId=a[2]);k&8&&(m.labelId=a[3]);k&16&&(m.step=a[4]);d.$set(m);m=b;{k=[(!h||k&20&&e!==(e=void 0!==a[4].options.text?a[2]:null))&&{"aria-describedby":e},
(!h||k&24&&f!==(f=a[4].options.title?a[3]:null))&&{"aria-labelledby":f},k&2&&a[1],{role:"dialog"},{tabindex:"0"}];let b={},c={},d={$$scope:1},g=l.length;for(;g--;){let a=l[g],e=k[g];if(e){for(u in a)u in e||(c[u]=1);for(let a in e)d[a]||(b[a]=e[a],d[a]=1);l[g]=e}else for(let b in a)d[b]=1}for(let a in c)a in b||(b[a]=void 0);var u=b}$a(m,p=u);U(b,"shepherd-has-cancel-icon",a[5]);U(b,"shepherd-has-title",a[6]);U(b,"shepherd-element",!0)},i(a){h||(n(d.$$.fragment,a),h=!0)},o(a){r(d.$$.fragment,a);h=
...
isReferenceHidden:e,hasPopperEscaped:h};b.attributes.popper=Object.assign(Object.assign({},b.attributes.popper),{},{"data-popper-reference-hidden":e,"data-popper-escaped":h})}}]});let V,ha=[],W=[],na=[],bb=[],Kb=Promise.resolve(),Ca=!1,Aa=!1,Ba=new Set,oa=new Set,O;class K{$destroy(){M(this,1);this.$destroy=v}$on(a,b){let c=this.$$.callbacks[a]||(this.$$.callbacks[a]=[]);c.push(b);return()=>{let a=c.indexOf(b);-1!==a&&c.splice(a,1)}}$set(a){this.$$set&&0!==Object.keys(a).length&&(this.$$.skip_bound=
