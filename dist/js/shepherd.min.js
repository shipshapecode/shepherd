...
"tabindex","0")},m:function(c,d,k){c.insertBefore(b,d||null);b.innerHTML=a[3];k&&e();e=la(b,"click",function(){Wa(a[0])&&a[0].apply(this,arguments)})},p:function(e,h){h=h[0];a=e;h&8&&(b.innerHTML=a[3]);h&16&&c!==(c=a[4]?a[4]:null)&&r(b,"aria-label",c);h&6&&d!==(d=(a[1]||"")+" shepherd-button "+(a[2]?"shepherd-button-secondary":""))&&r(b,"class",d);h&32&&(b.disabled=a[5])},i:z,o:z,d:function(a){a&&B(b);e()}}}function Gb(a,b,c){var d=b.config,e=b.step,f,h,k,l,g,m;a.$set=function(a){"config"in a&&c(6,
d=a.config);"step"in a&&c(7,e=a.step)};a.$$.update=function(){if(a.$$.dirty&192){c(0,f=d.action?d.action.bind(e.tour):null);c(1,h=d.classes);c(2,k=d.secondary);c(3,l=d.text);c(4,g=d.label);if(d.disabled){var b=d.disabled;b=R(b)?b.call(e):b}else b=!1;c(5,m=b)}};return[f,h,k,l,g,m,d,e]}function ab(a,b,c){a=a.slice();a[2]=b[c];return a}function bb(a){for(var b,c,d=a[1],e=[],f=0;f<d.length;f+=1)e[f]=cb(ab(a,d,f));var h=function(a){return v(e[a],1,1,function(){e[a]=null})};return{c:function(){for(var a=
0;a<e.length;a+=1)e[a].c();b=document.createTextNode("")},m:function(a,d){for(var f=0;f<e.length;f+=1)e[f].m(a,d);a.insertBefore(b,d||null);c=!0},p:function(a,c){if(c&3){d=a[1];var f;for(f=0;f<d.length;f+=1){var k=ab(a,d,f);e[f]?(e[f].p(k,c),n(e[f],1)):(e[f]=cb(k),e[f].c(),n(e[f],1),e[f].m(b.parentNode,b))}W();for(f=d.length;f<e.length;f+=1)h(f);X()}},i:function(a){if(!c){for(a=0;a<d.length;a+=1)n(e[a]);c=!0}},o:function(a){e=e.filter(Boolean);for(a=0;a<e.length;a+=1)v(e[a]);c=!1},d:function(a){for(var c=
e,d=0;d<c.length;d+=1)c[d]&&c[d].d(a);a&&B(b)}}}function cb(a){var b,c=new Hb({props:{config:a[2],step:a[0]}});return{c:function(){O(c.$$.fragment)},m:function(a,e){J(c,a,e);b=!0},p:function(a,b){var d={};b&2&&(d.config=a[2]);b&1&&(d.step=a[0]);c.$set(d)},i:function(a){b||(n(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){K(c,a)}}}function Ib(a){var b,c,d=a[1]&&bb(a);return{c:function(){b=document.createElement("footer");d&&d.c();r(b,"class","shepherd-footer")},m:function(a,
...
c=document.createElement("span");c.textContent="\u00d7";r(c,"aria-hidden","true");r(b,"aria-label",d=a[0].label?a[0].label:"Close Tour");r(b,"class","shepherd-cancel-icon");r(b,"type","button")},m:function(d,h,k){d.insertBefore(b,h||null);b.appendChild(c);k&&e();e=la(b,"click",a[1])},p:function(a,c){c[0]&1&&d!==(d=a[0].label?a[0].label:"Close Tour")&&r(b,"aria-label",d)},i:z,o:z,d:function(a){a&&B(b);e()}}}function Lb(a,b,c){var d=b.cancelIcon,e=b.step;a.$set=function(a){"cancelIcon"in a&&c(0,d=a.cancelIcon);
"step"in a&&c(2,e=a.step)};return[d,function(a){a.preventDefault();e.cancel()},e]}function Mb(a){var b;return{c:function(){b=document.createElement("h3");r(b,"id",a[1]);r(b,"class","shepherd-title")},m:function(c,d){c.insertBefore(b,d||null);a[3](b)},p:function(a,d){d[0]&2&&r(b,"id",a[1])},i:z,o:z,d:function(c){c&&B(b);a[3](null)}}}function Nb(a,b,c){var d=b.labelId,e=b.element,f=b.title;ma().$$.after_update.push(function(){R(f)&&c(2,f=f());c(0,e.innerHTML=f,e)});a.$set=function(a){"labelId"in a&&
c(1,d=a.labelId);"element"in a&&c(0,e=a.element);"title"in a&&c(2,f=a.title)};return[e,d,f,function(a){V[a?"unshift":"push"](function(){c(0,e=a)})}]}function db(a){var b,c=new Ob({props:{labelId:a[0],title:a[2]}});return{c:function(){O(c.$$.fragment)},m:function(a,e){J(c,a,e);b=!0},p:function(a,b){var d={};b&1&&(d.labelId=a[0]);b&4&&(d.title=a[2]);c.$set(d)},i:function(a){b||(n(c.$$.fragment,a),b=!0)},o:function(a){v(c.$$.fragment,a);b=!1},d:function(a){K(c,a)}}}function eb(a){var b,c=new Pb({props:{cancelIcon:a[3],
