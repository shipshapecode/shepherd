...
g.fragment=d?d(g.ctx):!1;b.target&&(b.hydrate?(c=Array.from(b.target.childNodes),g.fragment&&g.fragment.l(c),c.forEach(w)):g.fragment&&g.fragment.c(),b.intro&&n(a.$$.fragment),L(a,b.target,b.anchor),ab());V=k}function Lb(a){let b,c,d,e,f;return{c(){b=document.createElement("button");p(b,"aria-label",c=a[4]?a[4]:null);p(b,"class",d=`${a[1]||""} shepherd-button ${a[2]?"shepherd-button-secondary":""}`);b.disabled=a[5];p(b,"tabindex","0")},m(c,d){c.insertBefore(b,d||null);b.innerHTML=a[3];e||(f=la(b,
"click",function(){Ya(a[0])&&a[0].apply(this,arguments)}),e=!0)},p(e,[f]){a=e;f&8&&(b.innerHTML=a[3]);f&16&&c!==(c=a[4]?a[4]:null)&&p(b,"aria-label",c);f&6&&d!==(d=`${a[1]||""} shepherd-button ${a[2]?"shepherd-button-secondary":""}`)&&p(b,"class",d);f&32&&(b.disabled=a[5])},i:v,o:v,d(a){a&&w(b);e=!1;f()}}}function Mb(a,b,c){let {config:d}=b,{step:e}=b,f,h,k,m,g,l;a.$set=a=>{"config"in a&&c(6,d=a.config);"step"in a&&c(7,e=a.step)};a.$$.update=()=>{if(a.$$.dirty&192){c(0,f=d.action?d.action.bind(e.tour):
null);c(1,h=d.classes);c(2,k=d.secondary);c(3,m=d.text);c(4,g=d.label);if(d.disabled){var b=d.disabled;b=S(b)?b.call(e):b}else b=!1;c(5,l=b)}};return[f,h,k,m,g,l,d,e]}function cb(a,b,c){a=a.slice();a[2]=b[c];return a}function db(a){let b,c,d=a[1],e=[];for(let b=0;b<d.length;b+=1)e[b]=eb(cb(a,d,b));let f=a=>q(e[a],1,1,()=>{e[a]=null});return{c(){for(let a=0;a<e.length;a+=1)e[a].c();b=document.createTextNode("")},m(a,d){for(let b=0;b<e.length;b+=1)e[b].m(a,d);a.insertBefore(b,d||null);c=!0},p(a,c){if(c&
