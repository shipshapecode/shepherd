...
var Step = (function (_Evented) {
    ...
    _createClass(Step, [{
        ...
        value: function setupTether() {
            ...
            var tetherOpts = {
                classPrefix: setPrefix(this.options.classPrefix),
                element: this.el,
                constraints: [{
                    to: 'window',
                    pin: true,
        ...
        value: function _show() {
            ...
            addClass(this.el, this.options.classPrefix + '-open');

            document.body.setAttribute('data-' + this.options.classPrefix + '-step', this.id);
        ...
        value: function hide() {
            ...
            removeClass(this.el, this.options.classPrefix + '-open');

            document.body.removeAttribute('data-' + this.options.classPrefix + '-step');
        ...
        value: function isOpen() {
            return this.el && hasClass(this.el, this.options.classPrefix + '-open');
        }
    }, {
        key: 'cancel',
        ...
        value: function render() {
            ...
            this.el = createFromHTML('<div class=\'' + this.options.classPrefix + '-step ' + (this.options.classes || '') + '\' data-id=\'' + this.id + '\' ' + (this.options.idAttribute ? 'id="' + this.options.idAttribute + '"' : '') + '></div>');
            ...
            if (this.options.title) {
                header.innerHTML += '<h3 class=\'' + this.options.classPrefix + '-title\'>' + this.options.title + '</h3>';
                this.el.className += ' ' + this.options.classPrefix + '-has-title';
            }

            if (this.options.showCancelLink) {
                var link = createFromHTML('<a href class=\'' + this.options.classPrefix + '-cancel-link\'>✕</a>');
                header.appendChild(link);

                this.el.className += ' ' + this.options.classPrefix + '-has-cancel-link';
            ...
            if (!isUndefined(this.options.text)) {
                (function () {
                    var text = createFromHTML('<div class=\'' + _this5.options.classPrefix + '-text\'></div>');
            ...
            if (this.options.buttons) {
                (function () {
                    ...
                    var buttons = createFromHTML('<ul class=\'' + _this5.options.classPrefix + '-buttons\'></ul>');

                    _this5.options.buttons.map(function (cfg) {
                        var button = createFromHTML('<li><a class=\'' + _this5.options.classPrefix + '-button ' + (cfg.classes || '') + '\'>' + cfg.text + '</a>');
...
var Tour = (function (_Evented2) {
    ...
    _createClass(Tour, [{
        ...
        value: function done() {
            ...
            removeClass(document.body, setPrefix(this.options.defaults.classPrefix) + '-active');
        ...
        value: function show() {
            ...
            if (this.currentStep) {
                ...
                addClass(document.body, setPrefix(this.options.defaults.classPrefix) + '-active');
