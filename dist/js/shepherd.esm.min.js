...
function qa(a){return"html"===C(a)?a:a.parentNode||a.host||document.ownerDocument||document.documentElement}function getComputedStyle(a){return y(a).getComputedStyle(a)}function ra(a){if(0<=["html","body","#document"].indexOf(C(a)))return a.ownerDocument.body;if(B(a)){var b=getComputedStyle(a);if(/auto|scroll|overlay|hidden/.test(b.overflow+b.overflowY+b.overflowX))return a}return ra(qa(a))}
function sa(a,b){void 0===b&&(b=[]);var c=ra(a);c=(a="body"===C(c))?y(c):c;b=b.concat(c);return a?b:b.concat(sa(qa(c)))}function ta(a){var b;return!B(a)||!(b=a.offsetParent)||"undefined"!==typeof window.InstallTrigger&&"fixed"===getComputedStyle(b).position?null:b}function ua(a){var b=y(a);for(a=ta(a);a&&0<=["table","td","th"].indexOf(C(a));)a=ta(a);return a&&"body"===C(a)&&"static"===getComputedStyle(a).position?b:a||b}
...
g.onFirstUpdate)g.onFirstUpdate(a)});return n}}({defaultModifiers:[{name:"eventListeners",enabled:!0,phase:"write",fn:function(){},effect:function(a){var b=a.state,c=a.instance;a=a.options;var d=a.scroll,e=void 0===d?!0:d;a=a.resize;var f=void 0===a?!0:a,g=y(b.elements.popper),k=[].concat(b.scrollParents.reference,b.scrollParents.popper);e&&k.forEach(function(a){a.addEventListener("scroll",c.update,Fa)});f&&g.addEventListener("resize",c.update,Fa);return function(){e&&k.forEach(function(a){a.removeEventListener("scroll",
...
typeof k?k(Object.assign({},b.rects,{placement:b.placement})):k;k={x:0,y:0};if(e){var v="y"===m?top:"left",z="y"===m?"bottom":"right",w="y"===m?"height":"width";e=p[m];var A=p[m]+c[v],V=p[m]-c[z],O=f?-q[w]/2:0,ia="start"===l?n[w]:q[w];l="start"===l?-q[w]:-n[w];q=b.elements.arrow;q=f&&q?pa(q):{width:0,height:0};var P=b.modifiersData["arrow#persistent"]?b.modifiersData["arrow#persistent"].padding:{top:0,right:0,bottom:0,left:0};v=P[v];z=P[z];q=Math.max(0,Math.min(n[w],q[w]));ia=h?n[w]/2-O-q-v-r:ia-
q-v-r;h=h?-n[w]/2+O+q+z+r:l+q+z+r;r=b.elements.arrow&&ua(b.elements.arrow);n=b.modifiersData.offset?b.modifiersData.offset[b.placement][m]:0;r=p[m]+ia-n-(r?"y"===m?r.clientTop||0:r.clientLeft||0:0);h=p[m]+h-n;f=Math.max(f?Math.min(A,r):A,Math.min(e,f?Math.max(V,h):V));p[m]=f;k[m]=f-e}d&&(d=p[g],f=Math.max(d+c["x"===m?top:"left"],Math.min(d,d-c["x"===m?"bottom":"right"])),b.modifiersData.popperOffsets[g]=f,k[g]=f-d);b.modifiersData[a]=k},requiresIfExists:["offset"]},{name:"arrow",enabled:!0,phase:"main",
...
function S(a,b){a&&a.i&&(wb.delete(a),a.i(b))}function T(a,b,c,d){a&&a.o&&!wb.has(a)&&(wb.add(a),N.c.push(function(){wb.delete(a);d&&(c&&a.d(1),d())}),a.o(b))}function U(a){a&&a.c()}function W(a,b,c){var d=a.$$,e=d.fragment,f=d.on_mount,g=d.on_destroy;d=d.after_update;e&&e.m(b,c);sb(function(){var b=f.map(G).filter(ib);g?g.push.apply(g,b):b.forEach(G);a.$$.on_mount=[]});d.forEach(sb)}
...
function xb(a){var b,c,d,e;return{c:function(){b=document.createElement("button");J(b,"aria-label",c=a[4]?a[4]:null);J(b,"class",d=(a[1]||"")+" shepherd-button "+(a[2]?"shepherd-button-secondary":""));b.disabled=a[5];J(b,"tabindex","0")},m:function(c,d,k){c.insertBefore(b,d||null);b.innerHTML=a[3];k&&e();e=kb(b,"click",function(){ib(a[0])&&a[0].apply(this,arguments)})},p:function(e,g){g=g[0];a=e;g&8&&(b.innerHTML=a[3]);g&16&&c!==(c=a[4]?a[4]:null)&&J(b,"aria-label",c);g&6&&d!==(d=(a[1]||"")+" shepherd-button "+
(a[2]?"shepherd-button-secondary":""))&&J(b,"class",d);g&32&&(b.disabled=a[5])},i:F,o:F,d:function(a){a&&I(b);e()}}}function yb(a,b,c){var d=b.config,e=b.step,f,g,k,l,h,m;a.$set=function(a){"config"in a&&c(6,d=a.config);"step"in a&&c(7,e=a.step)};a.$$.update=function(){if(a.$$.dirty&192){c(0,f=d.action?d.action.bind(e.tour):null);c(1,g=d.classes);c(2,k=d.secondary);c(3,l=d.text);c(4,h=d.label);if(d.disabled){var b=d.disabled;b=x(b)?b.call(e):b}else b=!1;c(5,m=b)}};return[f,g,k,l,h,m,d,e]}
...
function Bb(a){function b(a){return T(f[a],1,1,function(){f[a]=null})}for(var c,d,e=a[1],f=[],g=0;g<e.length;g+=1)f[g]=Cb(Ab(a,e,g));return{c:function(){for(var a=0;a<f.length;a+=1)f[a].c();c=document.createTextNode("")},m:function(a,b){for(var e=0;e<f.length;e+=1)f[e].m(a,b);a.insertBefore(c,b||null);d=!0},p:function(a,d){if(d&3){e=a[1];var g;for(g=0;g<e.length;g+=1){var k=Ab(a,e,g);f[g]?(f[g].p(k,d),S(f[g],1)):(f[g]=Cb(k),f[g].c(),S(f[g],1),f[g].m(c.parentNode,c))}Q();for(g=e.length;g<f.length;g+=
1)b(g);R()}},i:function(){if(!d){for(var a=0;a<e.length;a+=1)S(f[a]);d=!0}},o:function(){f=f.filter(Boolean);for(var a=0;a<f.length;a+=1)T(f[a]);d=!1},d:function(a){for(var b=f,d=0;d<b.length;d+=1)b[d]&&b[d].d(a);a&&I(c)}}}
function Cb(a){var b,c=new zb({props:{config:a[2],step:a[0]}});return{c:function(){U(c.$$.fragment)},m:function(a,e){W(c,a,e);b=!0},p:function(a,b){var d={};b&2&&(d.config=a[2]);b&1&&(d.step=a[0]);c.$set(d)},i:function(a){b||(S(c.$$.fragment,a),b=!0)},o:function(a){T(c.$$.fragment,a);b=!1},d:function(a){X(c,a)}}}
function Db(a){var b,c,d=a[1]&&Bb(a);return{c:function(){b=document.createElement("footer");d&&d.c();J(b,"class","shepherd-footer")},m:function(a,f){a.insertBefore(b,f||null);d&&d.m(b,null);c=!0},p:function(a,c){c=c[0];a[1]?d?(d.p(a,c),S(d,1)):(d=Bb(a),d.c(),S(d,1),d.m(b,null)):d&&(Q(),T(d,1,1,function(){d=null}),R())},i:function(){c||(S(d),c=!0)},o:function(){T(d);c=!1},d:function(a){a&&I(b);d&&d.d()}}}
...
function Mb(a){var b,c=new Lb({props:{labelId:a[0],title:a[2]}});return{c:function(){U(c.$$.fragment)},m:function(a,e){W(c,a,e);b=!0},p:function(a,b){var d={};b&1&&(d.labelId=a[0]);b&4&&(d.title=a[2]);c.$set(d)},i:function(a){b||(S(c.$$.fragment,a),b=!0)},o:function(a){T(c.$$.fragment,a);b=!1},d:function(a){X(c,a)}}}
function Nb(a){var b,c=new Ib({props:{cancelIcon:a[3],step:a[1]}});return{c:function(){U(c.$$.fragment)},m:function(a,e){W(c,a,e);b=!0},p:function(a,b){var d={};b&8&&(d.cancelIcon=a[3]);b&2&&(d.step=a[1]);c.$set(d)},i:function(a){b||(S(c.$$.fragment,a),b=!0)},o:function(a){T(c.$$.fragment,a);b=!1},d:function(a){X(c,a)}}}
function Ob(a){var b,c,d,e=a[2]&&Mb(a),f=a[3]&&a[3].enabled&&Nb(a);return{c:function(){b=document.createElement("header");e&&e.c();c=document.createTextNode(" ");f&&f.c();J(b,"class","shepherd-header")},m:function(a,k){a.insertBefore(b,k||null);e&&e.m(b,null);b.appendChild(c);f&&f.m(b,null);d=!0},p:function(a,d){d=d[0];a[2]?e?(e.p(a,d),S(e,1)):(e=Mb(a),e.c(),S(e,1),e.m(b,c)):e&&(Q(),T(e,1,1,function(){e=null}),R());a[3]&&a[3].enabled?f?(f.p(a,d),S(f,1)):(f=Nb(a),f.c(),S(f,1),f.m(b,null)):f&&(Q(),
T(f,1,1,function(){f=null}),R())},i:function(){d||(S(e),S(f),d=!0)},o:function(){T(e);T(f);d=!1},d:function(a){a&&I(b);e&&e.d();f&&f.d()}}}function Pb(a,b,c){var d=b.labelId,e=b.step,f,g;a.$set=function(a){"labelId"in a&&c(0,d=a.labelId);"step"in a&&c(1,e=a.step)};a.$$.update=function(){a.$$.dirty&2&&(c(2,f=e.options.title),c(3,g=e.options.cancelIcon))};return[d,e,f,g]}var Qb=function(a){function b(b){var c=a.call(this)||this;Y(u(c),b,Pb,Ob,H,{labelId:0,step:1});return c}t(b,a);return b}(Z);
...
var Tb=function(a){function b(b){var c=a.call(this)||this;Y(u(c),b,Sb,Rb,H,{descriptionId:1,element:0,step:2});return c}t(b,a);return b}(Z);function Ub(a){var b,c=new Qb({props:{labelId:a[1],step:a[2]}});return{c:function(){U(c.$$.fragment)},m:function(a,e){W(c,a,e);b=!0},p:function(a,b){var d={};b&2&&(d.labelId=a[1]);b&4&&(d.step=a[2]);c.$set(d)},i:function(a){b||(S(c.$$.fragment,a),b=!0)},o:function(a){T(c.$$.fragment,a);b=!1},d:function(a){X(c,a)}}}
function Vb(a){var b,c=new Tb({props:{descriptionId:a[0],step:a[2]}});return{c:function(){U(c.$$.fragment)},m:function(a,e){W(c,a,e);b=!0},p:function(a,b){var d={};b&1&&(d.descriptionId=a[0]);b&4&&(d.step=a[2]);c.$set(d)},i:function(a){b||(S(c.$$.fragment,a),b=!0)},o:function(a){T(c.$$.fragment,a);b=!1},d:function(a){X(c,a)}}}
function Wb(a){var b,c=new Fb({props:{step:a[2]}});return{c:function(){U(c.$$.fragment)},m:function(a,e){W(c,a,e);b=!0},p:function(a,b){var d={};b&4&&(d.step=a[2]);c.$set(d)},i:function(a){b||(S(c.$$.fragment,a),b=!0)},o:function(a){T(c.$$.fragment,a);b=!1},d:function(a){X(c,a)}}}
function Xb(a){var b,c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled,d,e=void 0!==a[2].options.text,f,g=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length,k,l=c&&Ub(a),h=e&&Vb(a),m=g&&Wb(a);return{c:function(){b=document.createElement("div");l&&l.c();d=document.createTextNode(" ");h&&h.c();f=document.createTextNode(" ");m&&m.c();J(b,"class","shepherd-content")},m:function(a,c){a.insertBefore(b,c||null);l&&l.m(b,null);b.appendChild(d);h&&h.m(b,
null);b.appendChild(f);m&&m.m(b,null);k=!0},p:function(a,k){k=k[0];k&4&&(c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled);c?l?(l.p(a,k),S(l,1)):(l=Ub(a),l.c(),S(l,1),l.m(b,d)):l&&(Q(),T(l,1,1,function(){l=null}),R());k&4&&(e=void 0!==a[2].options.text);e?h?(h.p(a,k),S(h,1)):(h=Vb(a),h.c(),S(h,1),h.m(b,f)):h&&(Q(),T(h,1,1,function(){h=null}),R());k&4&&(g=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length);g?m?(m.p(a,k),S(m,1)):(m=Wb(a),m.c(),S(m,
1),m.m(b,null)):m&&(Q(),T(m,1,1,function(){m=null}),R())},i:function(){k||(S(l),S(h),S(m),k=!0)},o:function(){T(l);T(h);T(m);k=!1},d:function(a){a&&I(b);l&&l.d();h&&h.d();m&&m.d()}}}function Yb(a,b,c){var d=b.descriptionId,e=b.labelId,f=b.step;a.$set=function(a){"descriptionId"in a&&c(0,d=a.descriptionId);"labelId"in a&&c(1,e=a.labelId);"step"in a&&c(2,f=a.step)};return[d,e,f]}
var Zb=function(a){function b(b){var c=a.call(this)||this;Y(u(c),b,Yb,Xb,H,{descriptionId:0,labelId:1,step:2});return c}t(b,a);return b}(Z);function $b(){var a;return{c:function(){a=document.createElement("div");J(a,"class","shepherd-arrow");J(a,"data-popper-arrow","")},m:function(b,c){b.insertBefore(a,c||null)},d:function(b){b&&I(a)}}}
function ac(a){for(var b,c,d,e,f=a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element&&$b(),g=new Zb({props:{descriptionId:a[2],labelId:a[3],step:a[4]}}),k=[{"aria-describedby":void 0!==a[4].options.text?a[2]:null},{"aria-labelledby":a[4].options.title?a[3]:null},a[1],{role:"dialog"},{tabindex:"0"}],l={},h=0;h<k.length;h+=1)l=hb(l,k[h]);return{c:function(){b=document.createElement("div");f&&f.c();c=document.createTextNode(" ");U(g.$$.fragment);lb(b,l);K(b,"shepherd-has-cancel-icon",
...
24&&{"aria-labelledby":a[4].options.title?a[3]:null},e&2&&a[1],{role:"dialog"},{tabindex:"0"}];for(var h={},r={},l={$$scope:1},m=k.length;m--;){var w=k[m],A=e[m];if(A){for(var p in w)p in A||(r[p]=1);for(var O in A)l[O]||(h[O]=A[O],l[O]=1);k[m]=A}else for(var ia in w)l[ia]=1}for(var P in r)P in h||(h[P]=void 0);lb(d,h);K(b,"shepherd-has-cancel-icon",a[5]);K(b,"shepherd-has-title",a[6]);K(b,"shepherd-element",!0)},i:function(a){d||(S(g.$$.fragment,a),d=!0)},o:function(a){T(g.$$.fragment,a);d=!1},d:function(c){c&&
I(b);f&&f.d();X(g);a[17](null);e()}}}function bc(a){return a.split(" ").filter(function(a){return!!a.length})}
...
c(8,h=m[0]);c(10,n=m[m.length-1])});mb().$$.after_update.push(function(){w!==q.options.classes&&d()});a.$set=function(a){"classPrefix"in a&&c(11,g=a.classPrefix);"element"in a&&c(0,k=a.element);"descriptionId"in a&&c(2,l=a.descriptionId);"firstFocusableElement"in a&&c(8,h=a.firstFocusableElement);"focusableElements"in a&&c(9,m=a.focusableElements);"labelId"in a&&c(3,p=a.labelId);"lastFocusableElement"in a&&c(10,n=a.lastFocusableElement);"step"in a&&c(4,q=a.step);"dataStepId"in a&&c(1,r=a.dataStepId)};
...
b.next()}},h,m,n,g,function(){return k},w,d,e,f,function(a){M[a?"unshift":"push"](function(){c(0,k=a)})}]}var dc=function(a){function b(b){var c=a.call(this)||this;Y(u(c),b,cc,ac,H,{classPrefix:11,element:0,descriptionId:2,firstFocusableElement:8,focusableElements:9,labelId:3,lastFocusableElement:10,step:4,dataStepId:1,getElement:12});return c}t(b,a);ba(b,[{key:"getElement",get:function(){return this.$$.ctx[12]}}]);return b}(Z),ec=void 0;
