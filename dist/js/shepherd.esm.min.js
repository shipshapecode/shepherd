...
function db(a){var b;return function(){b||(b=new Promise(function(c){Promise.resolve().then(function(){b=void 0;c(a())})}));return b}}function eb(a){var b=a.reduce(function(a,b){var c=a[b.name];a[b.name]=c?Object.assign({},c,b,{options:Object.assign({},c.options,b.options),data:Object.assign({},c.data,b.data)}):b;return a},{});return Object.keys(b).map(function(a){return b[a]})}var fb={placement:"bottom",modifiers:[],strategy:"absolute"};
function gb(){for(var a=arguments.length,b=Array(a),c=0;c<a;c++)b[c]=arguments[c];return!b.some(function(a){return!(a&&"function"===typeof a.getBoundingClientRect)})}
var hb=function(a){void 0===a&&(a={});var b=a.defaultModifiers,c=void 0===b?[]:b;a=a.defaultOptions;var d=void 0===a?fb:a;return function(a,b,g){function e(){k.orderedModifiers.forEach(function(a){var b=a.name,c=a.options;c=void 0===c?{}:c;a=a.effect;"function"===typeof a&&(b=a({state:k,name:b,instance:q,options:c}),m.push(b||function(){}))})}function f(){m.forEach(function(a){return a()});m=[]}void 0===g&&(g=d);var k={placement:"bottom",orderedModifiers:[],options:Object.assign({},fb,d),modifiersData:{},
elements:{reference:a,popper:b},attributes:{},styles:{}},m=[],n=!1,q={state:k,setOptions:function(g){f();k.options=Object.assign({},d,k.options,g);k.scrollParents={reference:ua(a)?Qa(a):a.contextElement?Qa(a.contextElement):[],popper:Qa(b)};g=cb(eb([].concat(c,k.options.modifiers)));k.orderedModifiers=g.filter(function(a){return a.enabled});e();return q.update()},forceUpdate:function(){if(!n){var a=k.elements,b=a.reference;a=a.popper;if(gb(b,a))for(k.rects={reference:ab(b,Aa(a),"fixed"===k.options.strategy),
popper:wa(a)},k.reset=!1,k.placement=k.options.placement,k.orderedModifiers.forEach(function(a){return k.modifiersData[a.name]=Object.assign({},a.data)}),b=0;b<k.orderedModifiers.length;b++)if(!0===k.reset)k.reset=!1,b=-1;else{var c=k.orderedModifiers[b];a=c.fn;var d=c.options;d=void 0===d?{}:d;c=c.name;"function"===typeof a&&(k=a({state:k,options:d,name:c,instance:q})||k)}}},update:db(function(){return new Promise(function(a){q.forceUpdate();a(k)})}),destroy:function(){f();n=!0}};if(!gb(a,b))return q;
...
v="y"===n?"height":"width",na=g[n],I=g[n]+h[x],z=g[n]-h[y],Q=d?-r[v]/2:0,R="start"===k?q[v]:r[v];k="start"===k?-r[v]:-q[v];r=b.elements.arrow;r=d&&r?wa(r):{width:0,height:0};var ib=b.modifiersData["arrow#persistent"]?b.modifiersData["arrow#persistent"].padding:{top:0,right:0,bottom:0,left:0};x=ib[x];y=ib[y];r=F(0,G(q[v],r[v]));R=m?q[v]/2-Q-r-x-p:R-r-x-p;q=m?-q[v]/2+Q+r+y+p:k+r+y+p;m=b.elements.arrow&&Aa(b.elements.arrow);p=b.modifiersData.offset?b.modifiersData.offset[b.placement][n]:0;m=g[n]+R-p-
(m?"y"===n?m.clientTop||0:m.clientLeft||0:0);q=g[n]+q-p;e&&(e=d?G(I,m):I,z=d?F(z,q):z,e=F(e,G(na,z)),g[n]=e,l[n]=e-na);f&&(f=g[c],e=f+h["x"===n?top:"left"],h=f-h["x"===n?"bottom":"right"],e=d?G(e,m):e,d=d?F(h,q):h,d=F(e,G(f,d)),g[c]=d,l[c]=d-f)}b.modifiersData[a]=l}},requiresIfExists:["offset"]},{name:"arrow",enabled:!0,phase:"main",fn:function(a){var b,c=a.state,d=a.name,e=a.options,f=c.elements.arrow,g=c.modifiersData.popperOffsets,l=C(c.placement);a=Ba(l);l=0<=["left","right"].indexOf(l)?"height":
...
function qb(a,b){if(a.popperOptions){let c=Object.assign({},b,a.popperOptions);if(a.popperOptions.modifiers&&0<a.popperOptions.modifiers.length){let d=a.popperOptions.modifiers.map(a=>a.name);b=b.modifiers.filter(a=>!d.includes(a.name));c.modifiers=Array.from(new Set([...b,...a.popperOptions.modifiers]))}return c}return b}function H(){}function rb(a,b){for(let c in b)a[c]=b[c];return a}function sb(a){return a()}function tb(a){return"function"===typeof a}
function J(a,b){return a!=a?b==b:a!==b||a&&"object"===typeof a||"function"===typeof a}let ub=!1,vb=new Set;function wb(){ub=!1;for(let a of vb)a.parentNode.removeChild(a);vb.clear()}function xb(a,b){ub&&vb.delete(b);b.parentNode!==a&&a.appendChild(b)}function K(a,b,c){ub&&vb.delete(b);(b.parentNode!==a||c&&b.nextSibling!==c)&&a.insertBefore(b,c||null)}function L(a){ub?vb.add(a):a.parentNode&&a.parentNode.removeChild(a)}
function yb(a){return document.createElementNS("http://www.w3.org/2000/svg",a)}function zb(a,b,c,d){a.addEventListener(b,c,d);return()=>a.removeEventListener(b,c,d)}function M(a,b,c){null==c?a.removeAttribute(b):a.getAttribute(b)!==c&&a.setAttribute(b,c)}function Ab(a,b){let c=Object.getOwnPropertyDescriptors(a.__proto__);for(let d in b)null==b[d]?a.removeAttribute(d):"style"===d?a.style.cssText=b[d]:"__value"===d?a.value=a[d]=b[d]:c[d]&&c[d].set?a[d]=b[d]:M(a,d,b[d])}
function Bb(a,b,c){a.classList[c?"add":"remove"](b)}let N;function Cb(){if(!N)throw Error("Function called outside component initialization");return N}let Db=[],Eb=[],Fb=[],Gb=[],Hb=Promise.resolve(),Ib=!1;function Jb(a){Fb.push(a)}let Kb=!1,Lb=new Set;
function Mb(){if(!Kb){Kb=!0;do{for(var a=0;a<Db.length;a+=1){var b=Db[a];N=b;b=b.$$;if(null!==b.fragment){b.update();b.before_update.forEach(sb);let a=b.dirty;b.dirty=[-1];b.fragment&&b.fragment.p(b.ctx,a);b.after_update.forEach(Jb)}}N=null;for(Db.length=0;Eb.length;)Eb.pop()();for(a=0;a<Fb.length;a+=1)b=Fb[a],Lb.has(b)||(Lb.add(b),b());Fb.length=0}while(Db.length);for(;Gb.length;)Gb.pop()();Kb=Ib=!1;Lb.clear()}}let Nb=new Set,O;function P(){O={r:0,c:[],p:O}}
function S(){O.r||O.c.forEach(sb);O=O.p}function T(a,b){a&&a.i&&(Nb.delete(a),a.i(b))}function U(a,b,c,d){a&&a.o&&!Nb.has(a)&&(Nb.add(a),O.c.push(()=>{Nb.delete(a);d&&(c&&a.d(1),d())}),a.o(b))}function V(a){a&&a.c()}function W(a,b,c,d){let {fragment:e,on_mount:f,on_destroy:g,after_update:l}=a.$$;e&&e.m(b,c);d||Jb(()=>{let b=f.map(sb).filter(tb);g?g.push(...b):b.forEach(sb);a.$$.on_mount=[]});l.forEach(Jb)}
function X(a,b){a=a.$$;null!==a.fragment&&(a.on_destroy.forEach(sb),a.fragment&&a.fragment.d(b),a.on_destroy=a.fragment=null,a.ctx=[])}
function Y(a,b,c,d,e,f,g=[-1]){let l=N;N=a;let h=a.$$={fragment:null,ctx:null,props:f,update:H,not_equal:e,bound:Object.create(null),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(l?l.$$.context:b.context||[]),callbacks:Object.create(null),dirty:g,skip_bound:!1},k=!1;h.ctx=c?c(a,b.props||{},(b,c,...d)=>{d=d.length?d[0]:c;if(h.ctx&&e(h.ctx[b],h.ctx[b]=d)){if(!h.skip_bound&&h.bound[b])h.bound[b](d);k&&(-1===a.$$.dirty[0]&&(Db.push(a),Ib||(Ib=!0,Hb.then(Mb)),
a.$$.dirty.fill(0)),a.$$.dirty[b/31|0]|=1<<b%31)}return c}):[];h.update();k=!0;h.before_update.forEach(sb);h.fragment=d?d(h.ctx):!1;b.target&&(b.hydrate?(ub=!0,c=Array.from(b.target.childNodes),h.fragment&&h.fragment.l(c),c.forEach(L)):h.fragment&&h.fragment.c(),b.intro&&T(a.$$.fragment),W(a,b.target,b.anchor,b.customElement),wb(),Mb());N=l}
class Z{$destroy(){X(this,1);this.$destroy=H}$on(a,b){let c=this.$$.callbacks[a]||(this.$$.callbacks[a]=[]);c.push(b);return()=>{let a=c.indexOf(b);-1!==a&&c.splice(a,1)}}$set(a){this.$$set&&0!==Object.keys(a).length&&(this.$$.skip_bound=!0,this.$$set(a),this.$$.skip_bound=!1)}}
function Ob(a){let b,c,d,e,f;return{c(){b=document.createElement("button");M(b,"aria-label",c=a[3]?a[3]:null);M(b,"class",d=`${a[1]||""} shepherd-button ${a[4]?"shepherd-button-secondary":""}`);b.disabled=a[2];M(b,"tabindex","0")},m(c,d){K(c,b,d);b.innerHTML=a[5];e||(f=zb(b,"click",function(){tb(a[0])&&a[0].apply(this,arguments)}),e=!0)},p(e,[f]){a=e;f&32&&(b.innerHTML=a[5]);f&8&&c!==(c=a[3]?a[3]:null)&&M(b,"aria-label",c);f&18&&d!==(d=`${a[1]||""} shepherd-button ${a[4]?"shepherd-button-secondary":
""}`)&&M(b,"class",d);f&4&&(b.disabled=a[2])},i:H,o:H,d(a){a&&L(b);e=!1;f()}}}function Pb(a,b,c){let {config:d}=b,{step:e}=b,f,g,l,h,k,m;a.$$set=a=>{"config"in a&&c(6,d=a.config);"step"in a&&c(7,e=a.step)};a.$$.update=()=>{if(a.$$.dirty&192){c(0,f=d.action?d.action.bind(e.tour):null);c(1,g=d.classes);if(d.disabled){var b=d.disabled;b=u(b)?b.call(e):b}else b=!1;c(2,l=b);c(3,h=d.label);c(4,k=d.secondary);c(5,m=d.text)}};return[f,g,l,h,k,m,d,e]}
class Qb extends Z{constructor(a){super();Y(this,a,Pb,Ob,J,{config:6,step:7})}}function Rb(a,b,c){a=a.slice();a[2]=b[c];return a}
function Sb(a){let b,c,d=a[1],e=[];for(let b=0;b<d.length;b+=1)e[b]=Tb(Rb(a,d,b));let f=a=>U(e[a],1,1,()=>{e[a]=null});return{c(){for(let a=0;a<e.length;a+=1)e[a].c();b=document.createTextNode("")},m(a,d){for(let b=0;b<e.length;b+=1)e[b].m(a,d);K(a,b,d);c=!0},p(a,c){if(c&3){d=a[1];let g;for(g=0;g<d.length;g+=1){let f=Rb(a,d,g);e[g]?(e[g].p(f,c),T(e[g],1)):(e[g]=Tb(f),e[g].c(),T(e[g],1),e[g].m(b.parentNode,b))}P();for(g=d.length;g<e.length;g+=1)f(g);S()}},i(){if(!c){for(let a=0;a<d.length;a+=1)T(e[a]);
c=!0}},o(){e=e.filter(Boolean);for(let a=0;a<e.length;a+=1)U(e[a]);c=!1},d(a){var c=e;for(let b=0;b<c.length;b+=1)c[b]&&c[b].d(a);a&&L(b)}}}function Tb(a){let b,c;b=new Qb({props:{config:a[2],step:a[0]}});return{c(){V(b.$$.fragment)},m(a,e){W(b,a,e);c=!0},p(a,c){let d={};c&2&&(d.config=a[2]);c&1&&(d.step=a[0]);b.$set(d)},i(a){c||(T(b.$$.fragment,a),c=!0)},o(a){U(b.$$.fragment,a);c=!1},d(a){X(b,a)}}}
function Ub(a){let b,c,d=a[1]&&Sb(a);return{c(){b=document.createElement("footer");d&&d.c();M(b,"class","shepherd-footer")},m(a,f){K(a,b,f);d&&d.m(b,null);c=!0},p(a,[c]){a[1]?d?(d.p(a,c),c&2&&T(d,1)):(d=Sb(a),d.c(),T(d,1),d.m(b,null)):d&&(P(),U(d,1,1,()=>{d=null}),S())},i(){c||(T(d),c=!0)},o(){U(d);c=!1},d(a){a&&L(b);d&&d.d()}}}function Vb(a,b,c){let d,{step:e}=b;a.$$set=a=>{"step"in a&&c(0,e=a.step)};a.$$.update=()=>{a.$$.dirty&1&&c(1,d=e.options.buttons)};return[e,d]}
class Wb extends Z{constructor(a){super();Y(this,a,Vb,Ub,J,{step:0})}}
function Xb(a){let b,c,d,e,f;return{c(){b=document.createElement("button");c=document.createElement("span");c.textContent="\u00d7";M(c,"aria-hidden","true");M(b,"aria-label",d=a[0].label?a[0].label:"Close Tour");M(b,"class","shepherd-cancel-icon");M(b,"type","button")},m(d,l){K(d,b,l);xb(b,c);e||(f=zb(b,"click",a[1]),e=!0)},p(a,[c]){c&1&&d!==(d=a[0].label?a[0].label:"Close Tour")&&M(b,"aria-label",d)},i:H,o:H,d(a){a&&L(b);e=!1;f()}}}
function Yb(a,b,c){let {cancelIcon:d}=b,{step:e}=b;a.$$set=a=>{"cancelIcon"in a&&c(0,d=a.cancelIcon);"step"in a&&c(2,e=a.step)};return[d,a=>{a.preventDefault();e.cancel()},e]}class Zb extends Z{constructor(a){super();Y(this,a,Yb,Xb,J,{cancelIcon:0,step:2})}}function $b(a){let b;return{c(){b=document.createElement("h3");M(b,"id",a[1]);M(b,"class","shepherd-title")},m(c,d){K(c,b,d);a[3](b)},p(a,[d]){d&2&&M(b,"id",a[1])},i:H,o:H,d(c){c&&L(b);a[3](null)}}}
function ac(a,b,c){let {labelId:d}=b,{element:e}=b,{title:f}=b;Cb().$$.after_update.push(()=>{u(f)&&c(2,f=f());c(0,e.innerHTML=f,e)});a.$$set=a=>{"labelId"in a&&c(1,d=a.labelId);"element"in a&&c(0,e=a.element);"title"in a&&c(2,f=a.title)};return[e,d,f,function(a){Eb[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}class bc extends Z{constructor(a){super();Y(this,a,ac,$b,J,{labelId:1,element:0,title:2})}}
function cc(a){let b,c;b=new bc({props:{labelId:a[0],title:a[2]}});return{c(){V(b.$$.fragment)},m(a,e){W(b,a,e);c=!0},p(a,c){let d={};c&1&&(d.labelId=a[0]);c&4&&(d.title=a[2]);b.$set(d)},i(a){c||(T(b.$$.fragment,a),c=!0)},o(a){U(b.$$.fragment,a);c=!1},d(a){X(b,a)}}}
function dc(a){let b,c;b=new Zb({props:{cancelIcon:a[3],step:a[1]}});return{c(){V(b.$$.fragment)},m(a,e){W(b,a,e);c=!0},p(a,c){let d={};c&8&&(d.cancelIcon=a[3]);c&2&&(d.step=a[1]);b.$set(d)},i(a){c||(T(b.$$.fragment,a),c=!0)},o(a){U(b.$$.fragment,a);c=!1},d(a){X(b,a)}}}
function ec(a){let b,c,d,e=a[2]&&cc(a),f=a[3]&&a[3].enabled&&dc(a);return{c(){b=document.createElement("header");e&&e.c();c=document.createTextNode(" ");f&&f.c();M(b,"class","shepherd-header")},m(a,l){K(a,b,l);e&&e.m(b,null);xb(b,c);f&&f.m(b,null);d=!0},p(a,[d]){a[2]?e?(e.p(a,d),d&4&&T(e,1)):(e=cc(a),e.c(),T(e,1),e.m(b,c)):e&&(P(),U(e,1,1,()=>{e=null}),S());a[3]&&a[3].enabled?f?(f.p(a,d),d&8&&T(f,1)):(f=dc(a),f.c(),T(f,1),f.m(b,null)):f&&(P(),U(f,1,1,()=>{f=null}),S())},i(){d||(T(e),T(f),d=!0)},o(){U(e);
U(f);d=!1},d(a){a&&L(b);e&&e.d();f&&f.d()}}}function fc(a,b,c){let {labelId:d}=b,{step:e}=b,f,g;a.$$set=a=>{"labelId"in a&&c(0,d=a.labelId);"step"in a&&c(1,e=a.step)};a.$$.update=()=>{a.$$.dirty&2&&(c(2,f=e.options.title),c(3,g=e.options.cancelIcon))};return[d,e,f,g]}class gc extends Z{constructor(a){super();Y(this,a,fc,ec,J,{labelId:0,step:1})}}
function hc(a){let b;return{c(){b=document.createElement("div");M(b,"class","shepherd-text");M(b,"id",a[1])},m(c,d){K(c,b,d);a[3](b)},p(a,[d]){d&2&&M(b,"id",a[1])},i:H,o:H,d(c){c&&L(b);a[3](null)}}}
function ic(a,b,c){let {descriptionId:d}=b,{element:e}=b,{step:f}=b;Cb().$$.after_update.push(()=>{let {text:a}=f.options;u(a)&&(a=a.call(f));a instanceof HTMLElement?e.appendChild(a):c(0,e.innerHTML=a,e)});a.$$set=a=>{"descriptionId"in a&&c(1,d=a.descriptionId);"element"in a&&c(0,e=a.element);"step"in a&&c(2,f=a.step)};return[e,d,f,function(a){Eb[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}class jc extends Z{constructor(a){super();Y(this,a,ic,hc,J,{descriptionId:1,element:0,step:2})}}
function kc(a){let b,c;b=new gc({props:{labelId:a[1],step:a[2]}});return{c(){V(b.$$.fragment)},m(a,e){W(b,a,e);c=!0},p(a,c){let d={};c&2&&(d.labelId=a[1]);c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(T(b.$$.fragment,a),c=!0)},o(a){U(b.$$.fragment,a);c=!1},d(a){X(b,a)}}}
function lc(a){let b,c;b=new jc({props:{descriptionId:a[0],step:a[2]}});return{c(){V(b.$$.fragment)},m(a,e){W(b,a,e);c=!0},p(a,c){let d={};c&1&&(d.descriptionId=a[0]);c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(T(b.$$.fragment,a),c=!0)},o(a){U(b.$$.fragment,a);c=!1},d(a){X(b,a)}}}
function mc(a){let b,c;b=new Wb({props:{step:a[2]}});return{c(){V(b.$$.fragment)},m(a,e){W(b,a,e);c=!0},p(a,c){let d={};c&4&&(d.step=a[2]);b.$set(d)},i(a){c||(T(b.$$.fragment,a),c=!0)},o(a){U(b.$$.fragment,a);c=!1},d(a){X(b,a)}}}
function nc(a){let b,c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled,d,e=void 0!==a[2].options.text,f,g=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length,l,h=c&&kc(a),k=e&&lc(a),m=g&&mc(a);return{c(){b=document.createElement("div");h&&h.c();d=document.createTextNode(" ");k&&k.c();f=document.createTextNode(" ");m&&m.c();M(b,"class","shepherd-content")},m(a,c){K(a,b,c);h&&h.m(b,null);xb(b,d);k&&k.m(b,null);xb(b,f);m&&m.m(b,null);l=!0},p(a,[l]){l&
4&&(c=void 0!==a[2].options.title||a[2].options.cancelIcon&&a[2].options.cancelIcon.enabled);c?h?(h.p(a,l),l&4&&T(h,1)):(h=kc(a),h.c(),T(h,1),h.m(b,d)):h&&(P(),U(h,1,1,()=>{h=null}),S());l&4&&(e=void 0!==a[2].options.text);e?k?(k.p(a,l),l&4&&T(k,1)):(k=lc(a),k.c(),T(k,1),k.m(b,f)):k&&(P(),U(k,1,1,()=>{k=null}),S());l&4&&(g=Array.isArray(a[2].options.buttons)&&a[2].options.buttons.length);g?m?(m.p(a,l),l&4&&T(m,1)):(m=mc(a),m.c(),T(m,1),m.m(b,null)):m&&(P(),U(m,1,1,()=>{m=null}),S())},i(){l||(T(h),
T(k),T(m),l=!0)},o(){U(h);U(k);U(m);l=!1},d(a){a&&L(b);h&&h.d();k&&k.d();m&&m.d()}}}function oc(a,b,c){let {descriptionId:d}=b,{labelId:e}=b,{step:f}=b;a.$$set=a=>{"descriptionId"in a&&c(0,d=a.descriptionId);"labelId"in a&&c(1,e=a.labelId);"step"in a&&c(2,f=a.step)};return[d,e,f]}class pc extends Z{constructor(a){super();Y(this,a,oc,nc,J,{descriptionId:0,labelId:1,step:2})}}
function qc(){let a;return{c(){a=document.createElement("div");M(a,"class","shepherd-arrow");M(a,"data-popper-arrow","")},m(b,c){K(b,a,c)},d(b){b&&L(a)}}}
...
Ab(b,n);Bb(b,"shepherd-has-cancel-icon",a[5]);Bb(b,"shepherd-has-title",a[6]);Bb(b,"shepherd-element",!0)},m(e,f){K(e,b,f);k&&k.m(b,null);xb(b,c);W(d,b,null);a[13](b);g=!0;l||(h=zb(b,"keydown",a[7]),l=!0)},p(a,[h]){a[4].options.arrow&&a[4].options.attachTo&&a[4].options.attachTo.element&&a[4].options.attachTo.on?k||(k=qc(),k.c(),k.m(b,c)):k&&(k.d(1),k=null);var p={};h&4&&(p.descriptionId=a[2]);h&8&&(p.labelId=a[3]);h&16&&(p.step=a[4]);d.$set(p);p=b;{h=[(!g||h&20&&e!==(e=void 0!==a[4].options.text?
a[2]:null))&&{"aria-describedby":e},(!g||h&24&&f!==(f=a[4].options.title?a[3]:null))&&{"aria-labelledby":f},h&2&&a[1],{role:"dialog"},{tabindex:"0"}];let b={},c={},d={$$scope:1},p=m.length;for(;p--;){let a=m[p],e=h[p];if(e){for(x in a)x in e||(c[x]=1);for(let a in e)d[a]||(b[a]=e[a],d[a]=1);m[p]=e}else for(let b in a)d[b]=1}for(let a in c)a in b||(b[a]=void 0);var x=b}Ab(p,n=x);Bb(b,"shepherd-has-cancel-icon",a[5]);Bb(b,"shepherd-has-title",a[6]);Bb(b,"shepherd-element",!0)},i(a){g||(T(d.$$.fragment,
a),g=!0)},o(a){U(d.$$.fragment,a);g=!1},d(c){c&&L(b);k&&k.d();X(d);a[13](null);l=!1;h()}}}function sc(a){return a.split(" ").filter(a=>!!a.length)}
function tc(a,b,c){let {classPrefix:d}=b,{element:e}=b,{descriptionId:f}=b,{firstFocusableElement:g}=b,{focusableElements:l}=b,{labelId:h}=b,{lastFocusableElement:k}=b,{step:m}=b,{dataStepId:n}=b,q,r,p;Cb().$$.on_mount.push(()=>{c(1,n={[`data-${d}shepherd-step-id`]:m.id});c(9,l=e.querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex="0"]'));c(8,g=l[0]);c(10,k=l[l.length-1])});Cb().$$.after_update.push(()=>
{if(p!==m.options.classes){var a=p;ka(a)&&(a=sc(a),a.length&&e.classList.remove(...a));a=p=m.options.classes;ka(a)&&(a=sc(a),a.length&&e.classList.add(...a))}});a.$$set=a=>{"classPrefix"in a&&c(11,d=a.classPrefix);"element"in a&&c(0,e=a.element);"descriptionId"in a&&c(2,f=a.descriptionId);"firstFocusableElement"in a&&c(8,g=a.firstFocusableElement);"focusableElements"in a&&c(9,l=a.focusableElements);"labelId"in a&&c(3,h=a.labelId);"lastFocusableElement"in a&&c(10,k=a.lastFocusableElement);"step"in
...
break;case 27:b.options.exitOnEsc&&m.cancel();break;case 37:b.options.keyboardNavigation&&b.back();break;case 39:b.options.keyboardNavigation&&b.next()}},g,l,k,d,()=>e,function(a){Eb[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}class uc extends Z{constructor(a){super();Y(this,a,tc,rc,J,{classPrefix:11,element:0,descriptionId:2,firstFocusableElement:8,focusableElements:9,labelId:3,lastFocusableElement:10,step:4,dataStepId:1,getElement:12})}get getElement(){return this.$$.ctx[12]}}var vc,wc=void 0;
...
var b=a.getBoundingClientRect(),d=this.getBoundingClientRect();a!==k.body?(l.call(this,a,a.scrollLeft+d.left-b.left,a.scrollTop+d.top-b.top),"fixed"!==h.getComputedStyle(a).position&&h.scrollBy({left:b.left,top:b.top,behavior:"smooth"})):h.scrollBy({left:d.left,top:d.top,behavior:"smooth"})}}}}}})()}(wc,wc.exports),wc.exports);vc.polyfill;vc.polyfill();
class xc extends la{constructor(a,b={}){super(a,b);this.tour=a;this.classPrefix=this.tour.options?mb(this.tour.options.classPrefix):"";this.styles=a.styles;ma(this);this._setOptions(b);return this}cancel(){this.tour.cancel();this.trigger("cancel")}complete(){this.tour.complete();this.trigger("complete")}destroy(){this.tooltip&&(this.tooltip.destroy(),this.tooltip=null);this.el instanceof HTMLElement&&this.el.parentNode&&(this.el.parentNode.removeChild(this.el),this.el=null);this._updateStepTargetOnHide();
...
function yc(a){a&&({steps:a}=a,a.forEach(a=>{a.options&&!1===a.options.canClickTarget&&a.options.attachTo&&a.target instanceof HTMLElement&&a.target.classList.remove("shepherd-target-click-disabled")}))}function zc({width:a,height:b,x:c=0,y:d=0,r:e=0}){let {innerWidth:f,innerHeight:g}=window;return`M${f},${g}\
H0\
V0\
H${f}\
V${g}\
...
V${d+e}\
a${e},${e},0,0,0-${e}-${e}\
Z`}function Ac(a){let b,c,d,e,f;return{c(){b=yb("svg");c=yb("path");M(c,"d",a[2]);M(b,"class",d=`${a[1]?"shepherd-modal-is-visible":""} shepherd-modal-overlay-container`)},m(d,l){K(d,b,l);xb(b,c);a[11](b);e||(f=zb(b,"touchmove",a[3]),e=!0)},p(a,[e]){e&4&&M(c,"d",a[2]);e&2&&d!==(d=`${a[1]?"shepherd-modal-is-visible":""} shepherd-modal-overlay-container`)&&M(b,"class",d)},i:H,o:H,d(c){c&&L(b);a[11](null);e=!1;f()}}}
function Bc(a){if(!a)return null;let b=a instanceof HTMLElement&&window.getComputedStyle(a).overflowY;return"hidden"!==b&&"visible"!==b&&a.scrollHeight>=a.clientHeight?a:Bc(a.parentElement)}
function Cc(a,b,c){function d(){c(4,m={width:0,height:0,x:0,y:0,r:0})}function e(){c(1,n=!1);l()}function f(a=0,b=0,e,f){if(f){var g=f.getBoundingClientRect();var h=g.y||g.top;g=g.bottom||h+g.height;if(e){var k=e.getBoundingClientRect();e=k.y||k.top;k=k.bottom||e+k.height;h=Math.max(h,e);g=Math.min(g,k)}h={y:h,height:Math.max(g-h,0)};let {y:d,height:l}=h,{x:n,width:p,left:x}=f.getBoundingClientRect();c(4,m={width:p+2*a,height:l+2*a,x:(n||x)-a,y:d-a,r:b})}else d()}function g(){c(1,n=!0)}function l(){q&&
(cancelAnimationFrame(q),q=void 0);window.removeEventListener("touchmove",p,{passive:!1})}function h(a){let {modalOverlayOpeningPadding:b,modalOverlayOpeningRadius:c}=a.options,d=Bc(a.target),e=()=>{q=void 0;f(b,c,d,a.target);q=requestAnimationFrame(e)};e();window.addEventListener("touchmove",p,{passive:!1})}let {element:k}=b,{openingProperties:m}=b;ob();let n=!1,q=void 0,r;d();let p=a=>{a.preventDefault()};a.$$set=a=>{"element"in a&&c(0,k=a.element);"openingProperties"in a&&c(4,m=a.openingProperties)};
a.$$.update=()=>{a.$$.dirty&16&&c(2,r=zc(m))};return[k,n,r,a=>{a.stopPropagation()},m,()=>k,d,e,f,function(a){l();a.tour.options.useModalOverlay?(h(a),g()):e()},g,function(a){Eb[a?"unshift":"push"](()=>{k=a;c(0,k)})}]}
class Dc extends Z{constructor(a){super();Y(this,a,Cc,Ac,J,{element:0,openingProperties:4,getElement:5,closeModalOpening:6,hide:7,positionModal:8,setupForStep:9,show:10})}get getElement(){return this.$$.ctx[5]}get closeModalOpening(){return this.$$.ctx[6]}get hide(){return this.$$.ctx[7]}get positionModal(){return this.$$.ctx[8]}get setupForStep(){return this.$$.ctx[9]}get show(){return this.$$.ctx[10]}}let Ec=new la;
class Fc extends la{constructor(a={}){super(a);ma(this);this.options=Object.assign({},{exitOnEsc:!0,keyboardNavigation:!0},a);this.classPrefix=mb(this.options.classPrefix);this.steps=[];this.addSteps(this.options.steps);"active cancel complete inactive show start".split(" ").map(a=>{(a=>{this.on(a,b=>{b=b||{};b.tour=this;Ec.trigger(a,b)})})(a)});this._setTourID();return this}addStep(a,b){a instanceof xc?a.tour=this:a=new xc(this,a);void 0!==b?this.steps.splice(b,0,a):this.steps.push(a);return a}addSteps(a){Array.isArray(a)&&
a.forEach(a=>{this.addStep(a)});return this}back(){let a=this.steps.indexOf(this.currentStep);this.show(a-1,!1)}cancel(){this.options.confirmCancel?window.confirm(this.options.confirmCancelMessage||"Are you sure you want to stop the tour?")&&this._done("cancel"):this._done("cancel")}complete(){this._done("complete")}getById(a){return this.steps.find(b=>b.id===a)}getCurrentStep(){return this.currentStep}hide(){let a=this.getCurrentStep();if(a)return a.hide()}isActive(){return Ec.activeTour===this}next(){let a=
...
previous:this.currentStep}),this.currentStep=a,a.show())}start(){this.trigger("start");this.focusedElBeforeOpen=document.activeElement;this.currentStep=null;this._setupModal();this._setupActiveTour();this.next()}_done(a){let b=this.steps.indexOf(this.currentStep);Array.isArray(this.steps)&&this.steps.forEach(a=>a.destroy());yc(this);this.trigger(a,{index:b});Ec.activeTour=null;this.trigger("inactive",{tour:this});this.modal&&this.modal.hide();"cancel"!==a&&"complete"!==a||!this.modal||(a=document.querySelector(".shepherd-modal-overlay-container"))&&
a.remove();this.focusedElBeforeOpen instanceof HTMLElement&&this.focusedElBeforeOpen.focus()}_setupActiveTour(){this.trigger("active",{tour:this});Ec.activeTour=this}_setupModal(){this.modal=new Dc({target:this.options.modalContainer||document.body,props:{classPrefix:this.classPrefix,styles:this.styles}})}_skipStep(a,b){a=this.steps.indexOf(a);this.show(b?a+1:a-1,b)}_updateStateBeforeShow(){this.currentStep&&this.currentStep.hide();this.isActive()||this._setupActiveTour()}_setTourID(){this.id=`${this.options.tourName||
"tour"}--${ob()}`}}Object.assign(Ec,{Tour:Fc,Step:xc});export default Ec
