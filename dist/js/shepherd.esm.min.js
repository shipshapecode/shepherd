...
a,a.show())};c.start=function(){this.trigger("start");this.focusedElBeforeOpen=document.activeElement;this.currentStep=null;this._setupActiveTour();this.next()};c._done=function(a){var b=this.steps.indexOf(this.currentStep);Array.isArray(this.steps)&&this.steps.forEach(function(a){return a.destroy()});fc(this);this.trigger(a,{index:b});kc.activeTour=null;this.trigger("inactive",{tour:this});this.modal.hide();this.focusedElBeforeOpen instanceof HTMLElement&&this.focusedElBeforeOpen.focus()};c._setupActiveTour=
