...
function X(a,b,c,d,e,f,h=[-1]){let m=M;M=a;let k=b.props||{},g=a.$$={fragment:null,ctx:null,props:f,update:C,not_equal:e,bound:Object.create(null),on_mount:[],on_destroy:[],before_update:[],after_update:[],context:new Map(m?m.$$.context:[]),callbacks:Object.create(null),dirty:h},l=!1;g.ctx=c?c(a,k,(b,c,...d)=>{d=d.length?d[0]:c;if(g.ctx&&e(g.ctx[b],g.ctx[b]=d)){if(g.bound[b])g.bound[b](d);l&&(-1===a.$$.dirty[0]&&(vb.push(a),zb||(zb=!0,yb.then(Db)),a.$$.dirty.fill(0)),a.$$.dirty[b/31|0]|=1<<b%31)}return c}):
[];g.update();l=!0;g.before_update.forEach(D);g.fragment=d?d(g.ctx):!1;b.target&&(b.hydrate?(c=Array.from(b.target.childNodes),g.fragment&&g.fragment.l(c),c.forEach(I)):g.fragment&&g.fragment.c(),b.intro&&R(a.$$.fragment),V(a,b.target,b.anchor),Db());M=m}class Y{$destroy(){W(this,1);this.$destroy=C}$on(a,b){let c=this.$$.callbacks[a]||(this.$$.callbacks[a]=[]);c.push(b);return()=>{let a=c.indexOf(b);-1!==a&&c.splice(a,1)}}$set(){}}
...
{if(p!==l.options.classes){var a=p;la(a)&&(a=jc(a),a.length&&e.classList.remove(...a));a=p=l.options.classes;la(a)&&(a=jc(a),a.length&&e.classList.add(...a))}});a.$set=a=>{"classPrefix"in a&&c(11,d=a.classPrefix);"element"in a&&c(0,e=a.element);"descriptionId"in a&&c(2,f=a.descriptionId);"firstFocusableElement"in a&&c(8,h=a.firstFocusableElement);"focusableElements"in a&&c(9,m=a.focusableElements);"labelId"in a&&c(3,k=a.labelId);"lastFocusableElement"in a&&c(10,g=a.lastFocusableElement);"step"in a&&
c(4,l=a.step);"dataStepId"in a&&c(1,n=a.dataStepId)};a.$$.update=()=>{a.$$.dirty&16&&(c(5,q=l.options&&l.options.cancelIcon&&l.options.cancelIcon.enabled),c(6,r=l.options&&l.options.title))};return[e,n,f,k,l,q,r,a=>{const {tour:b}=l;switch(a.keyCode){case 9:if(0===m.length){a.preventDefault();break}a.shiftKey?document.activeElement===h&&(a.preventDefault(),g.focus()):document.activeElement===g&&(a.preventDefault(),h.focus());break;case 27:b.options.exitOnEsc&&l.cancel();break;case 37:b.options.keyboardNavigation&&
b.back();break;case 39:b.options.keyboardNavigation&&b.next()}},h,m,g,d,()=>e,function(a){N[a?"unshift":"push"](()=>{e=a;c(0,e)})}]}class lc extends Y{constructor(a){super();X(this,a,kc,ic,G,{classPrefix:11,element:0,descriptionId:2,firstFocusableElement:8,focusableElements:9,labelId:3,lastFocusableElement:10,step:4,dataStepId:1,getElement:12})}get getElement(){return this.$$.ctx[12]}}var mc=void 0;
...
!0)}function m(){q&&(cancelAnimationFrame(q),q=void 0);window.removeEventListener("touchmove",p,{passive:!1})}function k(a){let {modalOverlayOpeningPadding:b,modalOverlayOpeningRadius:c}=a.options;if(a.target){let d=rc(a.target),e=()=>{q=void 0;f(a.target,d,b,c);q=requestAnimationFrame(e)};e();window.addEventListener("touchmove",p,{passive:!1})}else d()}let {element:g}=b,{openingProperties:l}=b;mb();let n=!1,q=void 0,r;d();let p=a=>{a.preventDefault()};a.$set=a=>{"element"in a&&c(0,g=a.element);"openingProperties"in
a&&c(4,l=a.openingProperties)};a.$$.update=()=>{a.$$.dirty&16&&c(2,r=pc(l))};return[g,n,r,a=>{a.stopPropagation()},l,()=>g,d,e,f,function(a){m();a.tour.options.useModalOverlay?(k(a),h()):e()},h,function(a){N[a?"unshift":"push"](()=>{g=a;c(0,g)})}]}
