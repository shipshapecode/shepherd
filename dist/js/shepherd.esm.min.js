...
function ua(a){var b=y(a).Element;return a instanceof b||a instanceof Element}function z(a){var b=y(a).HTMLElement;return a instanceof b||a instanceof HTMLElement}function A(a){return a.split("-")[0]}function va(a){return{x:a.offsetLeft,y:a.offsetTop,width:a.offsetWidth,height:a.offsetHeight}}
function wa(a,b){var c=b.getRootNode&&b.getRootNode();if(a.contains(b))return!0;var d=y(c).ShadowRoot;if(c instanceof d||c instanceof ShadowRoot){do{if(b&&a.isSameNode(b))return!0;b=b.parentNode||b.host}while(b)}return!1}function getComputedStyle(a){return y(a).getComputedStyle(a)}function B(a){return((ua(a)?a.ownerDocument:a.document)||window.document).documentElement}function xa(a){return"html"===w(a)?a:a.assignedSlot||a.parentNode||a.host||B(a)}
function ya(a){if(!z(a)||"fixed"===getComputedStyle(a).position)return null;if(a=a.offsetParent){var b=B(a);if("body"===w(a)&&"static"===getComputedStyle(a).position&&"static"!==getComputedStyle(b).position)return b}return a}
