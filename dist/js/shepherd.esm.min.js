...
{},{placement:b.placement})):m;m={x:0,y:0};if(n){if(e){var v="y"===l?top:"left",H="y"===l?"bottom":"right",x="y"===l?"height":"width";e=n[l];var ja=n[l]+c[v],E=n[l]-c[H],F=f?-r[x]/2:0,L="start"===k?q[x]:r[x];k="start"===k?-r[x]:-q[x];r=b.elements.arrow;r=f&&r?wa(r):{width:0,height:0};var V=b.modifiersData["arrow#persistent"]?b.modifiersData["arrow#persistent"].padding:{top:0,right:0,bottom:0,left:0};v=V[v];H=V[H];r=Math.max(0,Math.min(q[x],r[x]));L=g?q[x]/2-F-r-v-p:L-r-v-p;g=g?-q[x]/2+F+r+H+p:k+r+
