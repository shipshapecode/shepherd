...
a.$$.dirty[b/31|0]|=1<<b%31)}return c}):[];g.update();l=!0;g.before_update.forEach(D);g.fragment=d?d(g.ctx):!1;b.target&&(b.hydrate?(c=Array.from(b.target.childNodes),g.fragment&&g.fragment.l(c),c.forEach(I)):g.fragment&&g.fragment.c(),b.intro&&R(a.$$.fragment),V(a,b.target,b.anchor),Db());M=m}
...
a&&c(4,l=a.step);"dataStepId"in a&&c(1,n=a.dataStepId)};a.$$.update=()=>{a.$$.dirty&16&&(c(5,q=l.options&&l.options.cancelIcon&&l.options.cancelIcon.enabled),c(6,r=l.options&&l.options.title))};return[e,n,f,k,l,q,r,a=>{const {tour:b}=l;switch(a.keyCode){case 9:if(0===m.length){a.preventDefault();break}a.shiftKey?document.activeElement===h&&(a.preventDefault(),g.focus()):document.activeElement===g&&(a.preventDefault(),h.focus());break;case 27:b.options.exitOnEsc&&l.cancel();break;case 37:b.options.keyboardNavigation&&
