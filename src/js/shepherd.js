...
class Step extends Evented {
    ...
    render(){
        ...
        if ( this.options.showCancelLink ) {
            const link = createFromHTML( `<a href class='${ this.options.classPrefix }-cancel-link'>✕</a>` );
        ...
        if ( !isUndefined( this.options.text ) ) {
            const text = createFromHTML( `<div class='${ this.options.classPrefix }-text'></div>` );
        ...
        if ( this.options.buttons ) {
            ...
            let buttons = createFromHTML( `<ul class='${ this.options.classPrefix }-buttons'></ul>` );

            this.options.buttons.map( cfg =>{
                const button = createFromHTML( `<li><a class='${ this.options.classPrefix }-button ${ cfg.classes || '' }'>${ cfg.text }</a>` );
