...
```javascript
import 'shepherd.js/dist/esm/css/shepherd.css';
```
...
<script
  type="module"
  src="https://cdn.jsdelivr.net/npm/shepherd.js@12.0.3/dist/esm/shepherd.mjs"
></script>
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/npm/shepherd.js@12.0.3/dist/esm/css/shepherd.css"
/>
```
